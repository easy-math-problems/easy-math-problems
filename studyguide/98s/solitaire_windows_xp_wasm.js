...
var moduleOverrides = {};
var fakeurl = "http://localhost:1000/";
//"https://www.freecell.io/uploads/games/files/freecellio/solitaire-windows-xp/1.3.0"
var key;
for (key in Module) {
...
var ASM_CONSTS = {
  6951: function ($0, $1, $2) {
    ...
    Module.canvas.addEventListener(
      "mouseenter",
      Module.__defosjs_mouseenter_listener
    );
    Module.canvas.addEventListener(
      "mouseleave",
      Module.__defosjs_mouseleave_listener
    );
  ...
  7807: function ($0) {
    ...
    if ("onpointerlockchange" in document) {
      document.addEventListener(
        "pointerlockchange",
        Module.__defosjs_pointerlockchange_listener,
        false
      );
  ...
  8679: function () {
    ...
    document.removeEventListener(
      "mousemove",
      Module.__defosjs_mousemove_listener
    );
    document.removeEventListener(
      "pointerlockchange",
      Module.__defosjs_pointerlockchange_listener
  ...
  10218: function () {
    var jsString = fakeurl.substring(0, fakeurl.lastIndexOf("/"));//location.href.substring(0, location.href.lastIndexOf("/"));
...
function _dmDeviceJSOpen(bufferCount) {
  ...
  if (window.AudioContext || window.webkitAudioContext) {
    if (shared.audioCtx === undefined) {
      shared.audioCtx = new (window.AudioContext ||
    ...
    device = {
      ...
      _queue: function (samples, sample_count) {
        var buf = shared.audioCtx.createBuffer(
          2,
          sample_count,
          this.sampleRate
        );
...
function _dmScriptHttpRequestAsync(
  method,
  url,
  headers,
  arg,
  ...
  function listener() {
    ...
    if (xhr.status != 0) {
      ...
      var resp_headers_buffer = allocate(
        intArrayFromString(resp_headers),
        "i8",
        ALLOC_NORMAL
      );
...
function _dmSysGetApplicationPath() {
  var path = fakeurl.substring(0, fakeurl.lastIndexOf("/"));
...
function _dmSysGetUserPreferredLanguage(defaultlang) {
  ...
  var preferred =
    navigator == undefined
      ? jsdefault
      : navigator.languages
      ? navigator.languages[0] || jsdefault
      : navigator.language ||
...
var GLFW = {
  ...
  touchWasFinished: function (event, phase) {
    ...
    for (var i = 0; i < event.changedTouches.length; ++i) {
      ...
      var coord = GLFW.convertCoordinatesFromMonitorToWebGLPixels(
        touch.clientX,
        touch.clientY
      );
      var canvasX = coord[0];
  ...
  onTouchMove: function (event) {
    ...
    for (var i = 0; i < e.changedTouches.length; ++i) {
      ...
      coord = GLFW.convertCoordinatesFromMonitorToWebGLPixels(
        touch.clientX,
        touch.clientY
      );
      canvasX = coord[0];
...
function _glfwInitJS() {
  ...
  GLFW.addEventListener(
    "gamepaddisconnected",
    GLFW.onJoystickDisconnected,
    true
  );
  ...
  __ATEXIT__.push({
    func: function () {
      GLFW.removeEventListener(
        "gamepadconnected",
        GLFW.onJoystickConnected,
        true
      );
      GLFW.removeEventListener(
        "gamepaddisconnected",
...
function _js_addDesignEvent(eventId, fields) {
  gameanalytics.GameAnalytics.addDesignEvent(UTF8ToString(eventId));
}
function _js_addDesignEventWithValue(eventId, value, fields) {
  gameanalytics.GameAnalytics.addDesignEvent(UTF8ToString(eventId), value);
}
function _js_addErrorEvent(severity, message, fields) {
  gameanalytics.GameAnalytics.addErrorEvent(severity, UTF8ToString(message));
}
function _js_addProgressionEvent(
  progressionStatus,
  progression01,
  progression02,
  progression03,
...
function _js_addProgressionEventWithScore(
  progressionStatus,
  progression01,
  progression02,
  progression03,
...
var asmLibraryArg = {
  ...
  _: _abort,
  If: _clock,
  Hf: defos_set_cursor_locked_,
  Gf: _difftime,
  Ff: _dmDeviceJSFreeBufferSlots,
  Ef: _dmDeviceJSOpen,
  Df: _dmDeviceJSQueue,
  Cf: _dmGetDeviceSampleRate,
  Bf: _dmScriptHttpRequestAsync,
  Af: _dmSysGetApplicationPath,
  zf: _dmSysGetUserAgent,
  yf: _dmSysGetUserPersistentDataRoot,
  xf: _dmSysGetUserPreferredLanguage,
  wf: _dmSysOpenURL,
  Ca: _emscripten_asm_const_double,
  ...
  sf: _emscripten_glBeginQueryEXT,
  rf: _emscripten_glBindAttribLocation,
  qf: _emscripten_glBindBuffer,
  pf: _emscripten_glBindFramebuffer,
  of: _emscripten_glBindRenderbuffer,
  nf: _emscripten_glBindTexture,
  ...
  hf: _emscripten_glBlendFunc,
  gf: _emscripten_glBlendFuncSeparate,
  ff: _emscripten_glBufferData,
  ef: _emscripten_glBufferSubData,
  df: _emscripten_glCheckFramebufferStatus,
  cf: _emscripten_glClear,
  bf: _emscripten_glClearColor,
  af: _emscripten_glClearDepthf,
  $e: _emscripten_glClearStencil,
  _e: _emscripten_glColorMask,
  Ze: _emscripten_glCompileShader,
  Ye: _emscripten_glCompressedTexImage2D,
  Xe: _emscripten_glCompressedTexSubImage2D,
  We: _emscripten_glCopyTexImage2D,
  Ve: _emscripten_glCopyTexSubImage2D,
  ...
  Oe: _emscripten_glDeleteQueriesEXT,
  Ne: _emscripten_glDeleteRenderbuffers,
  Me: _emscripten_glDeleteShader,
  Le: _emscripten_glDeleteTextures,
  Ke: _emscripten_glDeleteVertexArraysOES,
  Je: _emscripten_glDepthFunc,
  Ie: _emscripten_glDepthMask,
  He: _emscripten_glDepthRangef,
  Ge: _emscripten_glDetachShader,
  Fe: _emscripten_glDisable,
  Ee: _emscripten_glDisableVertexAttribArray,
  De: _emscripten_glDrawArrays,
  Ce: _emscripten_glDrawArraysInstancedANGLE,
  Be: _emscripten_glDrawBuffersWEBGL,
  Ae: _emscripten_glDrawElements,
  ze: _emscripten_glDrawElementsInstancedANGLE,
  ye: _emscripten_glEnable,
  xe: _emscripten_glEnableVertexAttribArray,
  we: _emscripten_glEndQueryEXT,
  ...
  re: _emscripten_glFrontFace,
  qe: _emscripten_glGenBuffers,
  pe: _emscripten_glGenFramebuffers,
  oe: _emscripten_glGenQueriesEXT,
  ne: _emscripten_glGenRenderbuffers,
  me: _emscripten_glGenTextures,
  le: _emscripten_glGenVertexArraysOES,
  ke: _emscripten_glGenerateMipmap,
  je: _emscripten_glGetActiveAttrib,
  ie: _emscripten_glGetActiveUniform,
  he: _emscripten_glGetAttachedShaders,
  ge: _emscripten_glGetAttribLocation,
  fe: _emscripten_glGetBooleanv,
  ee: _emscripten_glGetBufferParameteriv,
  de: _emscripten_glGetError,
  ce: _emscripten_glGetFloatv,
  be: _emscripten_glGetFramebufferAttachmentParameteriv,
  ae: _emscripten_glGetIntegerv,
  $d: _emscripten_glGetProgramInfoLog,
  _d: _emscripten_glGetProgramiv,
  Zd: _emscripten_glGetQueryObjecti64vEXT,
  Yd: _emscripten_glGetQueryObjectivEXT,
  Xd: _emscripten_glGetQueryObjectui64vEXT,
  Wd: _emscripten_glGetQueryObjectuivEXT,
  Vd: _emscripten_glGetQueryivEXT,
  Ud: _emscripten_glGetRenderbufferParameteriv,
  ...
  Od: _emscripten_glGetTexParameterfv,
  Nd: _emscripten_glGetTexParameteriv,
  Md: _emscripten_glGetUniformLocation,
  Ld: _emscripten_glGetUniformfv,
  Kd: _emscripten_glGetUniformiv,
  Jd: _emscripten_glGetVertexAttribPointerv,
  Id: _emscripten_glGetVertexAttribfv,
  Hd: _emscripten_glGetVertexAttribiv,
  Gd: _emscripten_glHint,
  Fd: _emscripten_glIsBuffer,
  Ed: _emscripten_glIsEnabled,
  Dd: _emscripten_glIsFramebuffer,
  Cd: _emscripten_glIsProgram,
  Bd: _emscripten_glIsQueryEXT,
  Ad: _emscripten_glIsRenderbuffer,
  zd: _emscripten_glIsShader,
  yd: _emscripten_glIsTexture,
  xd: _emscripten_glIsVertexArrayOES,
  wd: _emscripten_glLineWidth,
  vd: _emscripten_glLinkProgram,
  ud: _emscripten_glPixelStorei,
  td: _emscripten_glPolygonOffset,
  sd: _emscripten_glQueryCounterEXT,
  ...
  dd: _emscripten_glTexParameterf,
  cd: _emscripten_glTexParameterfv,
  bd: _emscripten_glTexParameteri,
  ad: _emscripten_glTexParameteriv,
  $c: _emscripten_glTexSubImage2D,
  _c: _emscripten_glUniform1f,
  Zc: _emscripten_glUniform1fv,
  Yc: _emscripten_glUniform1i,
  Xc: _emscripten_glUniform1iv,
  ...
  Oc: _emscripten_glUniform4f,
  Nc: _emscripten_glUniform4fv,
  Mc: _emscripten_glUniform4i,
  Lc: _emscripten_glUniform4iv,
  Kc: _emscripten_glUniformMatrix2fv,
  Jc: _emscripten_glUniformMatrix3fv,
  ...
  xc: _emscripten_glVertexAttribDivisorANGLE,
  wc: _emscripten_glVertexAttribPointer,
  vc: _emscripten_glViewport,
  k: _emscripten_longjmp,
  uc: _emscripten_memcpy_big,
  tc: _emscripten_pause_main_loop,
  sc: _emscripten_resize_heap,
  Z: _emscripten_set_main_loop_arg,
  rc: _emscripten_thread_sleep,
  Kf: _environ_get,
  Jf: _environ_sizes_get,
  Ba: _exit,
  C: _fd_close,
  Da: _fd_read,
  La: _fd_seek,
  ...
  _b: _glFramebufferTexture2D,
  sa: _glGenBuffers,
  Zb: _glGenFramebuffers,
  J: _glGenRenderbuffers,
  Yb: _glGenTextures,
  Xb: _glGetActiveUniform,
  Wb: _glGetAttribLocation,
  c: _glGetError,
  U: _glGetIntegerv,
  ...
  Ob: _glUniform1i,
  Nb: _glUniform4fv,
  Mb: _glUniformMatrix4fv,
  oa: _glUseProgram,
  na: _glVertexAttribPointer,
  Lb: _glViewport,
  Kb: _glfwAccelerometerEnable,
  Jb: _glfwCloseWindow,
  Ib: _glfwGetAcceleration,
  ma: _glfwGetDefaultFramebuffer,
  ...
  Cb: _glfwGetMousePos,
  Bb: _glfwGetMouseWheel,
  R: _glfwGetProcAddress,
  Ab: _glfwGetWindowParam,
  zb: _glfwGetWindowRefreshRate,
  la: _glfwGetWindowSize,
  yb: _glfwIconifyWindow,
  xb: _glfwInitJS,
  wb: _glfwOpenWindow,
  Q: _glfwOpenWindowHint,
  vb: _glfwPollEvents,
  ub: _glfwResetKeyboard,
  tb: _glfwSetCharCallback,
  sb: _glfwSetGamepadCallback,
  rb: _glfwSetMarkedTextCallback,
  qb: _glfwSetTouchCallback,
  pb: _glfwSetWindowCloseCallback,
  ob: _glfwSetWindowFocusCallback,
  nb: _glfwSetWindowIconifyCallback,
  ka: _glfwSetWindowSize,
  mb: _glfwSetWindowSizeCallback,
  ja: _glfwShowKeyboard,
  lb: _glfwSwapBuffers,
  ...
  ga: _js_setEnabledInfoLog,
  fa: _js_setEnabledVerboseLog,
  ea: _js_setEventSubmission,
  da: _js_setManualSessionHandling,
  Ma: _js_startSession,
  a: wasmMemory,
  ca: _mktime,
  Ja: _pthread_create,
...
var _free = (Module["_free"] = function () {
  return (_free = Module["_free"] = Module["asm"]["bg"]).apply(null, arguments);
});
var _malloc = (Module["_malloc"] = function () {
  return (_malloc = Module["_malloc"] = Module["asm"]["cg"]).apply(
    null,
    arguments
  );
});
var _defos_emit_event_from_js = (Module["_defos_emit_event_from_js"] =
  function () {
    return (_defos_emit_event_from_js = Module["_defos_emit_event_from_js"] =
      Module["asm"]["dg"]).apply(null, arguments);
  });
var _js_remote_configs_callback = (Module["_js_remote_configs_callback"] =
  function () {
    return (_js_remote_configs_callback = Module[
      "_js_remote_configs_callback"
    ] =
      Module["asm"]["eg"]).apply(null, arguments);
  });
var _htonl = (Module["_htonl"] = function () {
  return (_htonl = Module["_htonl"] = Module["asm"]["fg"]).apply(
    null,
    arguments
  );
});
...
var _htons = (Module["_htons"] = function () {
  return (_htons = Module["_htons"] = Module["asm"]["ig"]).apply(
    null,
    arguments
  );
});
var _ntohs = (Module["_ntohs"] = function () {
  return (_ntohs = Module["_ntohs"] = Module["asm"]["jg"]).apply(
    null,
    arguments
  );
});
var _JSWriteDump = (Module["_JSWriteDump"] = function () {
  return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["kg"]).apply(
    null,
    arguments
  );
});
var __get_tzname = (Module["__get_tzname"] = function () {
  return (__get_tzname = Module["__get_tzname"] = Module["asm"]["lg"]).apply(
    null,
    arguments
  );
});
...
var stackSave = (Module["stackSave"] = function () {
  return (stackSave = Module["stackSave"] = Module["asm"]["og"]).apply(
    null,
    arguments
  );
});
var stackRestore = (Module["stackRestore"] = function () {
  return (stackRestore = Module["stackRestore"] = Module["asm"]["pg"]).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module["stackAlloc"] = function () {
  return (stackAlloc = Module["stackAlloc"] = Module["asm"]["qg"]).apply(
    null,
    arguments
  );
});
var _setThrew = (Module["_setThrew"] = function () {
  return (_setThrew = Module["_setThrew"] = Module["asm"]["rg"]).apply(
    null,
    arguments
  );
});
var dynCall_jii = (Module["dynCall_jii"] = function () {
  return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["sg"]).apply(
    null,
    arguments
  );
});
