(function (scope) {
    ...
    (function (o) {
      ...
      var e = {},
        ...
        d = (n.WordArray = i.extend({
          ...
          random: function (e) {
            for (var n = [], t = 0; t < e; t += 4)
              n.push((4294967296 * o.random()) | 0);
        ...
        l = (n.BufferedBlockAlgorithm = i.extend({
          ...
          _process: function (e) {
            ...
            if (
              ((e =
                (s = e ? o.ceil(s) : o.max((0 | s) - this._minBufferSize, 0)) *
                r),
              (i = o.min(4 * e, i)),
              e)
            ) {
  ...
  !(function (r) {
    ...
    for (
      ...
      u &&
        (d < 8 && (a[d] = e(r.pow(o, 0.5))), (f[d] = e(r.pow(o, 1 / 3))), d++),
        o++;
    }
    var m = [];
    s = s.SHA256 = i.extend({
      ...
      _doFinalize: function () {
        ...
        return (
          (n[i >>> 5] |= 128 << (24 - (i % 32))),
          (n[14 + (((64 + i) >>> 9) << 4)] = r.floor(t / 4294967296)),
          (n[15 + (((64 + i) >>> 9) << 4)] = t),
      ...
      CryptoJS.algo.HMAC = CryptoJS.lib.Base.extend({
        init: function (e, n) {
          (e = this._hasher = new e.init()),
            "string" == typeof n && (n = u.parse(n));
          var t = e.blockSize,
            i = 4 * t;
          n.sigBytes > i && (n = e.finalize(n)), n.clamp();
          for (
            var r = (this._oKey = n.clone()),
    ...
    (function (e) {
      ...
      ((n = e.EGAErrorSeverity || (e.EGAErrorSeverity = {}))[
        ...
        ((t = e.EGAProgressionStatus || (e.EGAProgressionStatus = {}))[
          (t.Undefined = 0)
        ] = "Undefined"),
        (t[(t.Start = 1)] = "Start"),
        (t[(t.Complete = 2)] = "Complete"),
        (t[(t.Fail = 3)] = "Fail"),
        ((i = e.EGAResourceFlowType || (e.EGAResourceFlowType = {}))[
          (i.Undefined = 0)
        ] = "Undefined"),
        (i[(i.Source = 1)] = "Source"),
        (i[(i.Sink = 2)] = "Sink"),
        ((r = e.EGAAdAction || (e.EGAAdAction = {}))[(r.Undefined = 0)] =
          "Undefined"),
        (r[(r.Clicked = 1)] = "Clicked"),
        (r[(r.Show = 2)] = "Show"),
        (r[(r.FailedShow = 3)] = "FailedShow"),
        (r[(r.RewardReceived = 4)] = "RewardReceived"),
        ((s = e.EGAAdError || (e.EGAAdError = {}))[(s.Undefined = 0)] =
          "Undefined"),
        ...
        ((a = e.EGAAdType || (e.EGAAdType = {}))[(a.Undefined = 0)] =
          "Undefined"),
        (a[(a.Video = 1)] = "Video"),
        ...
        (a[(a.Banner = 6)] = "Banner"),
        (o = e.http || (e.http = {})),
        ((d = o.EGAHTTPApiResponse || (o.EGAHTTPApiResponse = {}))[
          (d.NoResponse = 0)
        ] = "NoResponse"),
        ...
        (u = e.events || (e.events = {})),
        ((l = u.EGASdkErrorCategory || (u.EGASdkErrorCategory = {}))[
          (l.Undefined = 0)
        ] = "Undefined"),
        ...
        (l[(l.Http = 4)] = "Http"),
        (l[(l.Json = 5)] = "Json"),
        ((c = u.EGASdkErrorArea || (u.EGASdkErrorArea = {}))[
          (c.Undefined = 0)
        ] = "Undefined"),
        ...
        ((v = u.EGASdkErrorAction || (u.EGASdkErrorAction = {}))[
          (v.Undefined = 0)
        ] = "Undefined"),
        ...
        (v[(v.NotFoundInAvailableCurrencies = 8)] =
          "NotFoundInAvailableCurrencies"),
        (v[(v.InvalidAmount = 9)] = "InvalidAmount"),
        (v[(v.NotFoundInAvailableItemTypes = 10)] =
        ...
        ((g = u.EGASdkErrorParameter || (u.EGASdkErrorParameter = {}))[
          (g.Undefined = 0)
        ] = "Undefined"),
  ...
  !(function (e) {
    ...
    (function (e) {
      ...
      (n = e.utilities || (e.utilities = {})),
        ...
        (l.getHmac = function (e, n) {
          var t = CryptoJS.HmacSHA256(n, e);
          return CryptoJS.enc.Base64.stringify(t);
        }),
        (l.stringMatch = function (e, n) {
          return !(!e || !n) && n.test(e);
        }),
        (l.joinStringArray = function (e, n) {
          for (var t = "", i = 0, r = e.length; i < r; i++)
            0 < i && (t += n), (t += e[i]);
          return t;
        }),
        (l.stringArrayContainsString = function (e, n) {
        ...
        (l.decode64 = function (e) {
          ...
          for (
            ...
            (n =
              (l.keyStr.indexOf(e.charAt(d++)) << 2) |
              ((i = l.keyStr.indexOf(e.charAt(d++))) >> 4)),
              (t =
                ((15 & i) << 4) | ((r = l.keyStr.indexOf(e.charAt(d++))) >> 2)),
              (a = ((3 & r) << 6) | (o = l.keyStr.indexOf(e.charAt(d++)))),
      ...
      !(function (e) {
        ...
        var n =
              ...
              ? o.stringArrayContainsString(s, n)
                        ...
                        ? o.stringArrayContainsString(a, i)
                          ...
                          : (d.w(
                            ...
                            new g(
                              u.EventValidation,
                              l.ResourceEvent,
                              c.NotFoundInAvailableItemTypes,
                              v.ItemType,
                              i
                            ))
                        : (d.w(
                ...
                : (d.w(
                  ...
                  new g(
                    u.EventValidation,
                    l.ResourceEvent,
                    c.NotFoundInAvailableCurrencies,
                    v.Currency,
                    n
                  ))
              : (d.w(
          ...
          (f.validateProgressionEvent = function (e, n, t, i) {
            if (e == m.EGAProgressionStatus.Undefined)
              return (
                d.w(
            ...
            if (!f.validateEventPartLength(n, !1))
              return (
                d.w(
            ...
            if (!f.validateEventPartCharacters(n))
              return (
                d.w(
            ...
            if (t) {
              if (!f.validateEventPartLength(t, !0))
                return (
                  d.w(
              ...
              if (!f.validateEventPartCharacters(t))
                return (
                  d.w(
            ...
            if (i) {
              if (!f.validateEventPartLength(i, !0))
                return (
                  d.w(
              ...
              if (!f.validateEventPartCharacters(i))
                return (
                  d.w(
          ...
          (f.validateKeys = function (e, n) {
            return !(
              !o.stringMatch(e, /^[A-z0-9]{32}$/) ||
              !o.stringMatch(n, /^[A-z0-9]{40}$/)
            );
          }),
          ...
          (f.validateEventIdLength = function (e) {
            return (
              !!e && !!o.stringMatch(e, /^[^:]{1,64}(?::[^:]{1,64}){0,4}$/)
            );
          }),
          ...
          (f.validateResourceCurrencies = function (e) {
            if (!f.validateArrayOfStrings(20, 64, !1, "resource currencies", e))
              return !1;
            for (var n = 0; n < e.length; ++n)
              if (!o.stringMatch(e[n], /^[A-Za-z]+$/))
                return (
                  d.w(
          ...
          (f.validateResourceItemTypes = function (e) {
            if (!f.validateArrayOfStrings(20, 32, !1, "resource item types", e))
              return !1;
            for (var n = 0; n < e.length; ++n)
              if (!f.validateEventPartCharacters(e[n]))
                return (
                  d.w(
          ...
          (f.validateArrayOfStrings = function (e, n, t, i, r) {
            var s = i;
            if (((s = s || "Array"), !r))
              return d.w(s + " validation failed: array cannot be null. "), !1;
            if (0 == t && 0 == r.length)
              return d.w(s + " validation failed: array cannot be empty. "), !1;
            if (0 < e && r.length > e)
              return (
                d.w(
                  s +
      ...
      !(function (e) {
        ...
        var t =
          ...
          (r.getRelevantSdkVersion = function () {
            return r.sdkGameEngineVersion
              ? r.sdkGameEngineVersion
              : r.sdkWrapperVersion;
          }),
          ...
          (r.updateConnectionType = function () {
            navigator.onLine
              ? (r.connectionType =
                  "ios" === r.buildPlatform || "android" === r.buildPlatform
                    ? "wwan"
                    : "lan")
          ...
          (r.getBrowserVersionString = function () {
            ...
            if (0 == t.length && "ios" === r.buildPlatform)
              return "webkit_" + r.osVersion;
            if (/trident/i.test(t[1]))
              return "IE " + ((e = /\brv[ :]+(\d+)/g.exec(n) || [])[1] || "");
            if (
              "Chrome" === t[1] &&
          ...
          (r.matchItem = function (e, n) {
            var t,
              ...
              r,
              s,
              a = new l("unknown", "0.0.0"),
              o = 0,
              d = 0;
            for (o = 0; o < n.length; o += 1)
              if (new RegExp(n[o].value, "i").test(e)) {
                if (
                  ((t = new RegExp(n[o].version + "[- /:;]([\\d._]+)", "i")),
                  (s = ""),
                  (i = e.match(t)) && i[1] && (r = i[1]),
                  r)
                ) {
                  var u = r.split(/[._]+/);
                  for (d = 0; d < Math.min(u.length, 3); d += 1)
                    s += u[d] + (d < Math.min(u.length, 3) - 1 ? "." : "");
                } else s = "0.0.0";
                return (a.name = n[o].name), (a.version = s), a;
              }
            return a;
          }),
          (r.sdkWrapperVersion = "javascript 4.1.6"),
          (r.osVersionPair = r.matchItem(
            [
              navigator.platform,
              navigator.userAgent,
    ...
    (function (a) {
      !(function (e) {
        ...
        ((n = c = e.EGAStoreArgsOperator || (e.EGAStoreArgsOperator = {}))[
          (n.Equal = 0)
        ] = "Equal"),
          (n[(n.LessOrEqual = 1)] = "LessOrEqual"),
          (n[(n.NotEqual = 2)] = "NotEqual"),
          ((i = t = e.EGAStore || (e.EGAStore = {}))[(i.Events = 0)] =
            "Events"),
        ...
        var s =
          ...
          (v.isStoreTooLargeForEvents = function () {
            return (
              v.instance.eventsStore.length + v.instance.sessionsStore.length >
              v.MaxNumberOfEntries
            );
          }),
          ...
          (v.save = function (e) {
            v.isStorageAvailable()
              ? (localStorage.setItem(
                  v.StringFormat(v.KeyFormat, e, v.EventsStoreKey),
                  JSON.stringify(v.instance.eventsStore)
                ),
                localStorage.setItem(
                  v.StringFormat(v.KeyFormat, e, v.SessionsStoreKey),
                  JSON.stringify(v.instance.sessionsStore)
                ),
                localStorage.setItem(
                  v.StringFormat(v.KeyFormat, e, v.ProgressionStoreKey),
                  JSON.stringify(v.instance.progressionStore)
                ),
                localStorage.setItem(
                  v.StringFormat(v.KeyFormat, e, v.ItemsStoreKey),
                  JSON.stringify(v.instance.storeItems)
                ))
          ...
          (v.load = function (e) {
            if (v.isStorageAvailable()) {
              try {
                (v.instance.eventsStore = JSON.parse(
                  localStorage.getItem(
                    v.StringFormat(v.KeyFormat, e, v.EventsStoreKey)
                  )
                )),
                  v.instance.eventsStore || (v.instance.eventsStore = []);
              } catch (e) {
                r.w("Load failed for 'events' store. Using empty store."),
                  (v.instance.eventsStore = []);
              }
              try {
                (v.instance.sessionsStore = JSON.parse(
                  localStorage.getItem(
                    v.StringFormat(v.KeyFormat, e, v.SessionsStoreKey)
                  )
                )),
                  v.instance.sessionsStore || (v.instance.sessionsStore = []);
              } catch (e) {
                r.w("Load failed for 'sessions' store. Using empty store."),
                  (v.instance.sessionsStore = []);
              }
              try {
                (v.instance.progressionStore = JSON.parse(
                  localStorage.getItem(
                    v.StringFormat(v.KeyFormat, e, v.ProgressionStoreKey)
                  )
                )),
                  v.instance.progressionStore ||
                    (v.instance.progressionStore = []);
              } catch (e) {
              ...
              try {
                (v.instance.storeItems = JSON.parse(
                  localStorage.getItem(
                    v.StringFormat(v.KeyFormat, e, v.ItemsStoreKey)
                  )
                )),
                  v.instance.storeItems || (v.instance.storeItems = {});
              } catch (e) {
          ...
          (v.setItem = function (e, n, t) {
            ...
            t
              ? (v.instance.storeItems[i] = t)
              : i in v.instance.storeItems && delete v.instance.storeItems[i];
          }),
          ...
          try {
            "object" == typeof localStorage
              ? (localStorage.setItem("testingLocalStorage", "yes"),
                ...
                (v.storageAvailable = !0))
              : (v.storageAvailable = !1);
          } catch (e) {}
        }
        e.GAStore = s;
      })(a.store || (a.store = {}));
    ...
    (function (e) {
      ...
      (n = e.state || (e.state = {})),
        ...
        (c.setUserId = function (e) {
          (c.instance.userId = e), c.cacheIdentifier();
        }),
        ...
        (c.setAvailableCustomDimensions01 = function (e) {
          r.validateCustomDimensions(e) &&
            ((c.instance.availableCustomDimensions01 = e),
        ...
        (c.setAvailableCustomDimensions02 = function (e) {
          r.validateCustomDimensions(e) &&
            ((c.instance.availableCustomDimensions02 = e),
            c.validateAndFixCurrentDimensions(),
            u.i(
        ...
        (c.setAvailableCustomDimensions03 = function (e) {
          r.validateCustomDimensions(e) &&
            ((c.instance.availableCustomDimensions03 = e),
            c.validateAndFixCurrentDimensions(),
            u.i(
        ...
        (c.setAvailableResourceCurrencies = function (e) {
          r.validateResourceCurrencies(e) &&
            ((c.instance.availableResourceCurrencies = e),
            u.i(
        ...
        (c.setAvailableResourceItemTypes = function (e) {
          r.validateResourceItemTypes(e) &&
            ((c.instance.availableResourceItemTypes = e),
            u.i(
        ...
        (c.setBuild = function (e) {
          (c.instance.build = e), u.i("Set build version: " + e);
        }),
        ...
        (c.getABTestingId = function () {
          return c.instance.abId;
        }),
        (c.getABTestingVariantId = function () {
          return c.instance.abVariantId;
        }),
        (c.prototype.setDefaultId = function (e) {
          (this.defaultUserId = e || ""), c.cacheIdentifier();
        }),
        ...
        (c.getSdkConfig = function () {
          var e,
            n = 0;
          for (var t in c.instance.sdkConfig) 0 === n && (e = t), ++n;
          if (e && 0 < n) return c.instance.sdkConfig;
          for (var t in ((n = 0), c.instance.sdkConfigCached))
            0 === n && (e = t), ++n;
          return e && 0 < n
            ? c.instance.sdkConfigCached
            : c.instance.sdkConfigDefault;
        }),
        (c.isEnabled = function () {
          return !!c.instance.initAuthorized;
        }),
        (c.setCustomDimension01 = function (e) {
          (c.instance.currentCustomDimension01 = e),
            o.setItem(c.getGameKey(), c.Dimension01Key, e),
            u.i("Set custom01 dimension value: " + e);
        }),
        (c.setCustomDimension02 = function (e) {
          (c.instance.currentCustomDimension02 = e),
            o.setItem(c.getGameKey(), c.Dimension02Key, e),
            u.i("Set custom02 dimension value: " + e);
        }),
        (c.setCustomDimension03 = function (e) {
          (c.instance.currentCustomDimension03 = e),
            o.setItem(c.getGameKey(), c.Dimension03Key, e),
            u.i("Set custom03 dimension value: " + e);
        }),
        ...
        (c.incrementProgressionTries = function (e) {
          ...
          (t.progression = e),
            (t.tries = n),
            o.insert(l.Progression, t, !0, "progression");
        }),
        (c.getProgressionTries = function (e) {
          return e in c.instance.progressionTries
            ? c.instance.progressionTries[e]
            : 0;
        }),
        (c.clearProgressionTries = function (e) {
          e in c.instance.progressionTries &&
            delete c.instance.progressionTries[e];
          var n = [];
          n.push(["progression", t.Equal, e]), o.delete(l.Progression, n);
        }),
        (c.setKeys = function (e, n) {
          (c.instance.gameKey = e), (c.instance.gameSecret = n);
        }),
        (c.setManualSessionHandling = function (e) {
          (c.instance.useManualSessionHandling = e),
            u.i("Use manual session handling: " + e);
        }),
        (c.setEnabledEventSubmission = function (e) {
          c.instance._isEventSubmissionEnabled = e;
        }),
        (c.getEventAnnotations = function () {
          var e = { v: 2 };
          (e.user_id = c.instance.identifier),
            (e.client_ts = c.getClientTsAdjusted()),
            ...
            (e.session_id = c.instance.sessionId),
            (e[c.SessionNumKey] = c.instance.sessionNum);
          var n = s.getConnectionType();
          if (
            (r.validateConnectionType(n) && (e.connection_type = n),
            s.gameEngineVersion && (e.engine_version = s.gameEngineVersion),
            c.instance.configurations)
          ) {
            var t = 0;
            for (var i in c.instance.configurations) {
              t++;
              break;
            }
          ...
          return (
            c.instance.abId && (e.ab_id = c.instance.abId),
            c.instance.abVariantId &&
              (e.ab_variant_id = c.instance.abVariantId),
            c.instance.build && (e.build = c.instance.build),
            e
          );
        }),
        (c.getSdkErrorEventAnnotations = function () {
          var e = { v: 2 };
          (e.category = c.CategorySdkError),
            (e.sdk_version = s.getRelevantSdkVersion()),
            (e.os_version = s.osVersion),
            (e.manufacturer = s.deviceManufacturer),
            (e.device = s.deviceModel),
        ...
        (c.getInitAnnotations = function () {
          var e = {};
          return (
            c.getIdentifier() || c.cacheIdentifier(),
            (e.user_id = c.getIdentifier()),
            (e.sdk_version = s.getRelevantSdkVersion()),
            (e.os_version = s.osVersion),
            (e.platform = s.buildPlatform),
            c.getBuild() ? (e.build = c.getBuild()) : (e.build = null),
            (e.session_num = c.getSessionNum()),
        ...
        (c.cacheIdentifier = function () {
          c.instance.userId
            ? (c.instance.identifier = c.instance.userId)
            : c.instance.defaultUserId &&
              (c.instance.identifier = c.instance.defaultUserId);
        }),
        (c.ensurePersistedStates = function () {
          o.isStorageAvailable() && o.load(c.getGameKey());
          var e = c.instance;
          e.setDefaultId(
            null != o.getItem(c.getGameKey(), c.DefaultUserIdKey)
              ? o.getItem(c.getGameKey(), c.DefaultUserIdKey)
              : d.createGuid()
          ),
            (e.sessionNum =
              null != o.getItem(c.getGameKey(), c.SessionNumKey)
                ? Number(o.getItem(c.getGameKey(), c.SessionNumKey))
                : 0),
            (e.transactionNum =
              null != o.getItem(c.getGameKey(), c.TransactionNumKey)
                ? Number(o.getItem(c.getGameKey(), c.TransactionNumKey))
                : 0),
            e.currentCustomDimension01
              ...
              : ((e.currentCustomDimension01 =
                  null != o.getItem(c.getGameKey(), c.Dimension01Key)
                    ? o.getItem(c.getGameKey(), c.Dimension01Key)
                    : ""),
                e.currentCustomDimension01),
            e.currentCustomDimension02
              ...
              : ((e.currentCustomDimension02 =
                  null != o.getItem(c.getGameKey(), c.Dimension02Key)
                    ? o.getItem(c.getGameKey(), c.Dimension02Key)
                    : ""),
                e.currentCustomDimension02),
            e.currentCustomDimension03
              ...
              : ((e.currentCustomDimension03 =
                  null != o.getItem(c.getGameKey(), c.Dimension03Key)
                    ? o.getItem(c.getGameKey(), c.Dimension03Key)
                    : ""),
                e.currentCustomDimension03);
          var n =
            null != o.getItem(c.getGameKey(), c.SdkConfigCachedKey)
              ? o.getItem(c.getGameKey(), c.SdkConfigCachedKey)
              : "";
          if (n) {
        ...
        (c.calculateServerTimeOffset = function (e) {
          return e - d.timeIntervalSince1970();
        }),
        (c.validateAndCleanCustomFields = function (e) {
          var n = {};
          if (e) {
            var t = 0;
            for (var i in e) {
              ...
              if (i && r)
                if (t < c.MAX_CUSTOM_FIELDS_COUNT) {
                  var s = new RegExp(
                    "^[a-zA-Z0-9_]{1," + c.MAX_CUSTOM_FIELDS_KEY_LENGTH + "}$"
                  );
                  if (d.stringMatch(i, s)) {
                    var a = typeof r;
                    if ("string" == a || r instanceof String)
                      r.length <= c.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH &&
                      0 < r.length
                        ? ((n[i] = r), ++t)
                        : u.w(
                            "validateAndCleanCustomFields: entry with key=" +
                              ...
                              c.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH +
                              ")"
                          );
                    ...
                    u.w(
                      "validateAndCleanCustomFields: entry with key=" +
                        ...
                        c.MAX_CUSTOM_FIELDS_KEY_LENGTH +
                        ")"
                    );
                } else
                  u.w(
        ...
        (c.validateAndFixCurrentDimensions = function () {
          r.validateDimension01(
            c.getCurrentCustomDimension01(),
            c.getAvailableCustomDimensions01()
          ) || c.setCustomDimension01(""),
            r.validateDimension02(
              c.getCurrentCustomDimension02(),
              c.getAvailableCustomDimensions02()
            ) || c.setCustomDimension02(""),
            r.validateDimension03(
              c.getCurrentCustomDimension03(),
              c.getAvailableCustomDimensions03()
            ) || c.setCustomDimension03("");
        }),
        (c.getConfigurationStringValue = function (e, n) {
          return c.instance.configurations[e]
            ? c.instance.configurations[e].toString()
            : n;
        }),
        (c.isRemoteConfigsReady = function () {
          return c.instance.remoteConfigsIsReady;
        }),
        (c.addRemoteConfigsListener = function (e) {
          c.instance.remoteConfigsListeners.indexOf(e) < 0 &&
            c.instance.remoteConfigsListeners.push(e);
        }),
        (c.removeRemoteConfigsListener = function (e) {
          var n = c.instance.remoteConfigsListeners.indexOf(e);
          -1 < n && c.instance.remoteConfigsListeners.splice(n, 1);
        }),
        (c.getRemoteConfigsContentAsString = function () {
          return JSON.stringify(c.instance.configurations);
        }),
        (c.populateConfigurations = function (e) {
          var n = e.configs;
          if (n) {
            c.instance.configurations = {};
    ...
    (function (e) {
      ...
      (n = e.tasks || (e.tasks = {})),
        ...
        (u.execute = function (e, n, t, i) {
          var r = new Date();
          if (
            (u.timestampMap[n] || (u.timestampMap[n] = r),
            u.countMap[n] || (u.countMap[n] = 0),
            3600 <= (r.getTime() - u.timestampMap[n].getTime()) / 1e3 &&
              ((u.timestampMap[n] = r), (u.countMap[n] = 0)),
            !(u.countMap[n] >= u.MaxCount))
          ) {
            var s = o.getHmac(i, t),
    ...
    (function (e) {
      ...
      function y() {
        (this.protocol = "https"),
          ...
          (this.baseUrl = this.protocol + "://" + this.hostName + "/" + this.version),//this.protocol + "://" + this.hostName + "/" + this.version),
      ...
      (l = e.http || (e.http = {})),
        ...
        (y.prototype.requestInit = function (e, n) {
          ...
          if (s) {
            var a = this.createPayloadData(s, this.useGzip),
              o = [];
            o.push(s),
              y.sendRequest(i, a, o, this.useGzip, y.initRequestCallback, n);
        ...
        (y.prototype.sendEventsInArray = function (e, n, t) {
          if (0 != e.length) {
            ...
            if (s) {
              ...
              o.push(s),
                o.push(n),
                o.push(e.length.toString()),
                y.sendRequest(
                  r,
                  a,
                  o,
                  this.useGzip,
                  y.sendEventInArrayRequestCallback,
                  t
                );
        ...
        (y.prototype.sendSdkErrorEvent = function (e, n, t, i, r, s, a) {
          if (
            ...
            if ((0 < f.length && (l.error_parameter = f), 0 < r.length)) {
              var m = r;
              r.length > y.MAX_ERROR_MESSAGE_LENGTH &&
                (m = r.substring(0, y.MAX_ERROR_MESSAGE_LENGTH)),
                (l.reason = m);
            }
            var E = [];
            E.push(l),
              (o = JSON.stringify(E))
                ? h.execute(d, u, o, a)
                : S.w("sendSdkErrorEvent: JSON encoding failed.");
          }
        }),
        (y.sendEventInArrayRequestCallback = function (e, n, t, i) {
          ...
          var d = y.instance.processRequestResponse(
            s,
            e.statusText,
            r,
            "Events"
          ...
          if (
            d == l.EGAHTTPApiResponse.Ok ||
            d == l.EGAHTTPApiResponse.Created ||
            d == l.EGAHTTPApiResponse.BadRequest
          ) {
            var u = r ? JSON.parse(r) : {};
            if (null == u)
              return (
                t(l.EGAHTTPApiResponse.JsonDecodeFailed, null, a, o),
                void y.instance.sendSdkErrorEvent(
                  v.Http,
                  g.EventsHttp,
        ...
        (y.initRequestCallback = function (e, n, t, i) {
          ...
          if (
            o == l.EGAHTTPApiResponse.Ok ||
            o == l.EGAHTTPApiResponse.Created ||
            o == l.EGAHTTPApiResponse.BadRequest
          ) {
            if (null == a)
              return (
                t(l.EGAHTTPApiResponse.JsonDecodeFailed, null, "", 0),
                void y.instance.sendSdkErrorEvent(
                  v.Http,
                  g.InitHttp,
                  f.FailHttpJsonDecode,
            ...
            if (o !== l.EGAHTTPApiResponse.BadRequest) {
              ...
              d
                ? t(o, d, "", 0)
                : t(l.EGAHTTPApiResponse.BadResponse, null, "", 0);
            } else t(o, null, "", 0);
          } else t(o, null, "", 0);
        }),
        ...
        (y.prototype.processRequestResponse = function (e, n, t, i) {
          return t
            ? 200 === e
              ? l.EGAHTTPApiResponse.Ok
              : 201 === e
              ? l.EGAHTTPApiResponse.Created
              : 0 === e || 401 === e
              ? l.EGAHTTPApiResponse.Unauthorized
              : 400 === e
              ? l.EGAHTTPApiResponse.BadRequest
              : 500 === e
              ? l.EGAHTTPApiResponse.InternalServerError
              : l.EGAHTTPApiResponse.UnknownResponseCode
            : l.EGAHTTPApiResponse.NoResponse;
        }),
    ...
    (function (g) {
      ...
      (f = g.events || (g.events = {})),
        (m = g.store.GAStore),
        (E = g.store.EGAStore),
        (p = g.store.EGAStoreArgsOperator),
        (S = g.state.GAState),
        (A = g.logging.GALogger),
        (h = g.utilities.GAUtilities),
        (u = g.http.EGAHTTPApiResponse),
        (y = g.http.GAHTTPApi),
        (b = g.validators.GAValidator),
          ...
          if ((void 0 === r && (r = null), S.isEventSubmissionEnabled())) {
            ...
            if (null == a) {
              ...
              S.incrementTransactionNum(),
                ...
                (o.currency = e),
                (o.amount = n),
                (o[S.TransactionNumKey] = S.getTransactionNum()),
                r && (o.cart_type = r),
                C.addDimensionsToEvent(o),
                C.addFieldsToEvent(o, S.validateAndCleanCustomFields(s)),
                A.i(
          ...
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == d) {
              var u,
                l = {};
              (u = t ? (i ? n + ":" + t + ":" + i : n + ":" + t) : n),
                (l.category = C.CategoryProgression),
                (l.event_id = o + ":" + u);
              var c = 0;
              s && e != g.EGAProgressionStatus.Start && (l.score = r),
                e === g.EGAProgressionStatus.Fail &&
                  S.incrementProgressionTries(u),
                e === g.EGAProgressionStatus.Complete &&
                  (S.incrementProgressionTries(u),
                  (c = S.getProgressionTries(u)),
                  (l.attempt_num = c),
                  S.clearProgressionTries(u)),
                C.addDimensionsToEvent(l),
                C.addFieldsToEvent(l, S.validateAndCleanCustomFields(a)),
                A.i(
        ...
        (C.addDesignEvent = function (e, n, t, i) {
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == r) {
              var s = {};
              (s.category = C.CategoryDesign),
                (s.event_id = e),
                t && (s.value = n),
                C.addDimensionsToEvent(s),
                C.addFieldsToEvent(s, S.validateAndCleanCustomFields(i)),
                A.i("Add DESIGN event: {eventId:" + e + ", value:" + n + "}"),
                C.addEventToStore(s);
            } else
              y.instance.sendSdkErrorEvent(
                r.category,
        ...
        (C.addErrorEvent = function (e, n, t) {
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == r) {
              var s = {};
              (s.category = C.CategoryError),
                (s.severity = i),
                (s.message = n),
                C.addDimensionsToEvent(s),
                C.addFieldsToEvent(s, S.validateAndCleanCustomFields(t)),
                A.i("Add ERROR event: {severity:" + i + ", message:" + n + "}"),
                C.addEventToStore(s);
            } else
              y.instance.sendSdkErrorEvent(
                r.category,
          ...
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == c) {
              ...
              (v.category = C.CategoryAds),
                ...
                (v.ad_type = u),
                (v.ad_action = d),
                e == g.EGAAdAction.FailedShow &&
                  0 < l.length &&
                  (v.ad_fail_show_reason = l),
                !a ||
                  (n != g.EGAAdType.RewardedVideo && n != g.EGAAdType.Video) ||
                  (v.ad_duration = s),
                C.addDimensionsToEvent(v),
                C.addFieldsToEvent(v, S.validateAndCleanCustomFields(o)),
                A.i(
                  "Add AD event: {ad_sdk_name:" +
                    ...
                    ", ad_action:" +
                    d +
                    (e == g.EGAAdAction.FailedShow && 0 < l.length
                      ? ", ad_fail_show_reason:" + l
                      : "") +
                    (!a ||
                    (n != g.EGAAdType.RewardedVideo && n != g.EGAAdType.Video)
                      ? ""
        ...
        (C.processEvents = function (e, n) {
          if (S.isEventSubmissionEnabled())
            try {
              ...
              var r = [];
              r.push(["status", p.Equal, "new"]),
                e &&
                  (i.push(["category", p.Equal, e]),
                  r.push(["category", p.Equal, e]));
              var s = [];
              s.push(["status", t]);
              ...
              if (a.length > C.MaxEventCount) {
                ...
                if (
                  (i.push(["client_ts", p.LessOrEqual, o]),
                  !(a = m.select(E.Events, i)))
                )
                  return;
                r.push(["client_ts", p.LessOrEqual, o]);
              }
              if (
                (A.i("Event queue: Sending " + a.length + " events."),
                !m.update(E.Events, s, r))
              )
                return;
              ...
              A.e("Error during ProcessEvents(): " + e.stack),
                y.instance.sendSdkErrorEvent(
                  f.EGASdkErrorCategory.Json,
                  f.EGASdkErrorArea.ProcessEvents,
                  f.EGASdkErrorAction.JsonError,
                  f.EGASdkErrorParameter.Undefined,
                  e.stack,
                  S.getGameKey(),
                  S.getGameSecret()
                );
        ...
        (C.processEventsCallback = function (e, n, t, i) {
          var r = [];
          if ((r.push(["status", p.Equal, t]), e === u.Ok))
            m.delete(E.Events, r), A.i("Event queue: " + i + " events sent.");
            ...
            if (n) {
              ...
              e === u.BadRequest && a.constructor === Array
                ? A.w(
                    "Event queue: " +
                      i +
                      " events sent. " +
        ...
        (C.fixMissingSessionEndEvents = function () {
          if (S.isEventSubmissionEnabled()) {
            ...
            if (n && 0 != n.length) {
              A.i(
                n.length + " session(s) located with missing session_end event."
              );
              for (var t = 0; t < n.length; ++t) {
                var i = JSON.parse(h.decode64(n[t].event)),
                  r = i.client_ts - n[t].timestamp;
                (r = Math.max(0, r)),
                  (i.category = C.CategorySessionEnd),
                  (i.length = r),
                  C.addEventToStore(i);
              }
            }
        ...
        (C.addEventToStore = function (e) {
          if (S.isEventSubmissionEnabled())
            if (S.isInitialized())
              try {
                if (
                  m.isStoreTooLargeForEvents() &&
                  !h.stringMatch(e.category, /^(user|session_end|business)$/)
                )
                  return (
                    A.w("Database too large. Event has been blocked."),
                    void y.instance.sendSdkErrorEvent(
                      f.EGASdkErrorCategory.Database,
                      f.EGASdkErrorArea.AddEventsToStore,
                      f.EGASdkErrorAction.DatabaseTooLarge,
                      f.EGASdkErrorParameter.Undefined,
                      "",
                      S.getGameKey(),
                      S.getGameSecret()
                ...
                (s.category = n.category),
                  ...
                  (s.event = h.encode64(JSON.stringify(n))),
                  m.insert(E.Events, s),
                  e.category == C.CategorySessionEnd
                    ...
                    : (((s = {}).session_id = n.session_id),
                      (s.timestamp = S.getSessionStart()),
                      (s.event = t),
                      m.insert(E.Sessions, s, !0, "session_id")),
                  m.isStorageAvailable() && m.save(S.getGameKey());
              } catch (i) {
        ...
        (C.updateSessionStore = function () {
          if (S.sessionIsStarted()) {
            ...
            (e.session_id = S.instance.sessionId),
              ...
              (e.event = h.encode64(JSON.stringify(S.getEventAnnotations()))),
              m.insert(E.Sessions, e, !0, "session_id"),
              m.isStorageAvailable() && m.save(S.getGameKey());
          }
        }),
        ...
        (C.resourceFlowTypeToString = function (e) {
          return e == g.EGAResourceFlowType.Source ||
            e == g.EGAResourceFlowType[g.EGAResourceFlowType.Source]
            ? "Source"
            : e == g.EGAResourceFlowType.Sink ||
              e == g.EGAResourceFlowType[g.EGAResourceFlowType.Sink]
            ? "Sink"
            : "";
        }),
        (C.progressionStatusToString = function (e) {
          return e == g.EGAProgressionStatus.Start ||
            e == g.EGAProgressionStatus[g.EGAProgressionStatus.Start]
            ? "Start"
            : e == g.EGAProgressionStatus.Complete ||
              e == g.EGAProgressionStatus[g.EGAProgressionStatus.Complete]
            ? "Complete"
            : e == g.EGAProgressionStatus.Fail ||
              e == g.EGAProgressionStatus[g.EGAProgressionStatus.Fail]
            ? "Fail"
            : "";
        }),
        (C.errorSeverityToString = function (e) {
          return e == g.EGAErrorSeverity.Debug ||
            e == g.EGAErrorSeverity[g.EGAErrorSeverity.Debug]
            ? "debug"
            : e == g.EGAErrorSeverity.Info ||
              e == g.EGAErrorSeverity[g.EGAErrorSeverity.Info]
            ? "info"
            : e == g.EGAErrorSeverity.Warning ||
              e == g.EGAErrorSeverity[g.EGAErrorSeverity.Warning]
            ? "warning"
            : e == g.EGAErrorSeverity.Error ||
              e == g.EGAErrorSeverity[g.EGAErrorSeverity.Error]
            ? "error"
            : e == g.EGAErrorSeverity.Critical ||
              e == g.EGAErrorSeverity[g.EGAErrorSeverity.Critical]
            ? "critical"
            : "";
        }),
        (C.adActionToString = function (e) {
          return e == g.EGAAdAction.Clicked ||
            e == g.EGAAdAction[g.EGAAdAction.Clicked]
            ? "clicked"
            : e == g.EGAAdAction.Show || e == g.EGAAdAction[g.EGAAdAction.Show]
            ? "show"
            : e == g.EGAAdAction.FailedShow ||
              e == g.EGAAdAction[g.EGAAdAction.FailedShow]
            ? "failed_show"
            : e == g.EGAAdAction.RewardReceived ||
              e == g.EGAAdAction[g.EGAAdAction.RewardReceived]
            ? "reward_received"
            : "";
        }),
        (C.adErrorToString = function (e) {
          return e == g.EGAAdError.Unknown ||
            e == g.EGAAdError[g.EGAAdError.Unknown]
            ? "unknown"
            : e == g.EGAAdError.Offline ||
              e == g.EGAAdError[g.EGAAdError.Offline]
            ? "offline"
            : e == g.EGAAdError.NoFill || e == g.EGAAdError[g.EGAAdError.NoFill]
            ? "no_fill"
            : e == g.EGAAdError.InternalError ||
              e == g.EGAAdError[g.EGAAdError.InternalError]
            ? "internal_error"
            : e == g.EGAAdError.InvalidRequest ||
              e == g.EGAAdError[g.EGAAdError.InvalidRequest]
            ? "invalid_request"
            : e == g.EGAAdError.UnableToPrecache ||
              e == g.EGAAdError[g.EGAAdError.UnableToPrecache]
            ? "unable_to_precache"
            : "";
        }),
        (C.adTypeToString = function (e) {
          return e == g.EGAAdType.Video || e == g.EGAAdType[g.EGAAdType.Video]
            ? "video"
            : e == g.EGAAdType.RewardedVideo ||
              e == g.EGAAdError[g.EGAAdType.RewardedVideo]
            ? "rewarded_video"
            : e == g.EGAAdType.Playable ||
              e == g.EGAAdError[g.EGAAdType.Playable]
            ? "playable"
            : e == g.EGAAdType.Interstitial ||
              e == g.EGAAdError[g.EGAAdType.Interstitial]
            ? "interstitial"
            : e == g.EGAAdType.OfferWall ||
    ...
    (function (e) {
      ...
      (r = e.threading || (e.threading = {})),
        ...
        (a.performTaskOnGAThread = function (e, n) {
          ...
          (i.block = e),
            (a.instance.id2TimedBlockMap[i.id] = i),
            a.instance.addTimedBlock(i);
        }),
        ...
        (a.getTimedBlockById = function (e) {
          return e in a.instance.id2TimedBlockMap
            ? a.instance.id2TimedBlockMap[e]
            : null;
        }),
        (a.ensureEventQueueIsRunning = function () {
          (a.instance.keepRunning = !0),
            a.instance.isRunning ||
              ((a.instance.isRunning = !0),
              a.scheduleTimer(
                a.ProcessEventsIntervalInSeconds,
                a.processEventQueue
              ));
        }),
        (a.endSessionAndStopQueue = function () {
          t.isInitialized() &&
            ...
            t.isEnabled() &&
              t.sessionIsStarted() &&
              (i.addSessionEndEvent(), (t.instance.sessionStart = 0)));
        }),
        (a.stopEventQueue = function () {
          a.instance.keepRunning = !1;
        }),
        (a.ignoreTimer = function (e) {
          e in a.instance.id2TimedBlockMap &&
            (a.instance.id2TimedBlockMap[e].ignore = !0);
        }),
        ...
        (a.run = function () {
          ...
          try {
            ...
            return void (a.runTimeoutId = setTimeout(
              a.run,
              a.ThreadWaitTimeInMs
            ));
          } catch (e) {
        ...
        (a.getNextBlock = function () {
          var e = new Date();
          return a.instance.blocks.hasItems() &&
            a.instance.blocks.peek().deadline.getTime() <= e.getTime()
            ? a.instance.blocks.peek().async && a.instance.blocks.peek().running
              ? a.instance.blocks.peek()
              : a.instance.blocks.dequeue()
            : null;
        }),
        (a.processEventQueue = function () {
          i.processEvents("", !0),
            a.instance.keepRunning
              ? a.scheduleTimer(
                  a.ProcessEventsIntervalInSeconds,
                  a.processEventQueue
                )
              : (a.instance.isRunning = !1);
        }),
        (a.instance = new a()),
      ...
      var o = a.threading.GAThreading,
        ...
        n =
          ...
          (m.init = function () {
            if (
              (c.touch(),
              (m.methodMap.configureAvailableCustomDimensions01 =
                m.configureAvailableCustomDimensions01),
              (m.methodMap.configureAvailableCustomDimensions02 =
                m.configureAvailableCustomDimensions02),
              (m.methodMap.configureAvailableCustomDimensions03 =
                m.configureAvailableCustomDimensions03),
              (m.methodMap.configureAvailableResourceCurrencies =
                m.configureAvailableResourceCurrencies),
              (m.methodMap.configureAvailableResourceItemTypes =
                m.configureAvailableResourceItemTypes),
              (m.methodMap.configureBuild = m.configureBuild),
              (m.methodMap.configureSdkGameEngineVersion =
                m.configureSdkGameEngineVersion),
              (m.methodMap.configureGameEngineVersion =
                m.configureGameEngineVersion),
              ...
              (m.methodMap.setEnabledManualSessionHandling =
                m.setEnabledManualSessionHandling),
              (m.methodMap.setEnabledEventSubmission =
                m.setEnabledEventSubmission),
              ...
              (m.methodMap.addRemoteConfigsListener =
                m.addRemoteConfigsListener),
              (m.methodMap.removeRemoteConfigsListener =
                m.removeRemoteConfigsListener),
              (m.methodMap.getRemoteConfigsValueAsString =
                m.getRemoteConfigsValueAsString),
              (m.methodMap.isRemoteConfigsReady = m.isRemoteConfigsReady),
              (m.methodMap.getRemoteConfigsContentAsString =
                m.getRemoteConfigsContentAsString),
              void 0 !== m.getGlobalObject() &&
                void 0 !== m.getGlobalObject().GameAnalytics &&
                void 0 !== m.getGlobalObject().GameAnalytics.q)
            ) {
              var e = m.getGlobalObject().GameAnalytics.q;
          ...
          (m.gaCommand = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            0 < e.length &&
              e[0] in a.GameAnalytics.methodMap &&
              (1 < e.length
                ? a.GameAnalytics.methodMap[e[0]].apply(
                    null,
                    Array.prototype.slice.call(e, 1)
                  )
                : a.GameAnalytics.methodMap[e[0]]());
          }),
            ...
            void 0 === e && (e = []),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ...
                  : l.setAvailableCustomDimensions01(e);
              });
          }),
            ...
            void 0 === e && (e = []),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ...
                  : l.setAvailableCustomDimensions02(e);
              });
          }),
            ...
            void 0 === e && (e = []),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ...
                  : l.setAvailableCustomDimensions03(e);
              });
          }),
            ...
            void 0 === e && (e = []),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ...
                  : l.setAvailableResourceCurrencies(e);
              });
          }),
            ...
            void 0 === e && (e = []),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ...
                  : l.setAvailableResourceItemTypes(e);
              });
          }),
          (m.configureBuild = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1)
                  ? d.w("Build version must be set before SDK is initialized.")
                  : i.validateBuild(e)
                  ? l.setBuild(e)
                  : d.i(
          ...
          (m.configureSdkGameEngineVersion = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1) ||
                  (i.validateSdkWrapperVersion(e)
                    ? (c.sdkGameEngineVersion = e)
                    : d.i(
          ...
          (m.configureGameEngineVersion = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !1) ||
                  (i.validateEngineVersion(e)
                    ? (c.gameEngineVersion = e)
                    : d.i(
            ...
            (t.async = !0),
              ...
              (t.block = function () {
                m.isSdkReady(!0, !1)
                  ...
                  : i.validateKeys(e, n)
                  ? (l.setKeys(e, n), m.internalInitialize())
                  : d.w(
          ...
          (m.addBusinessEvent = function (e, n, t, i, r) {
            void 0 === e && (e = ""),
              ...
              c.updateConnectionType(),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add business event") &&
                  f.addBusinessEvent(e, n, t, i, r, {});
              });
          }),
          (m.addResourceEvent = function (e, n, t, i, r) {
            void 0 === e && (e = a.EGAResourceFlowType.Undefined),
              ...
              c.updateConnectionType(),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add resource event") &&
                  f.addResourceEvent(e, n, t, i, r, {});
              });
          }),
          ...
          (m.addErrorEvent = function (e, n) {
            void 0 === e && (e = a.EGAErrorSeverity.Undefined),
              ...
              c.updateConnectionType(),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add error event") &&
                  f.addErrorEvent(e, n, {});
              });
          }),
          (m.addAdEventWithNoAdReason = function (e, n, t, i, r) {
            void 0 === e && (e = a.EGAAdAction.Undefined),
              ...
              c.updateConnectionType(),
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add ad event") &&
                  f.addAdEvent(e, n, t, i, r, 0, !1, {});
              });
          }),
          (m.addAdEventWithDuration = function (e, n, t, i, r) {
            void 0 === e && (e = a.EGAAdAction.Undefined),
              ...
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add ad event") &&
                  f.addAdEvent(e, n, t, i, a.EGAAdError.Undefined, r, !0, {});
              });
          }),
          (m.addAdEvent = function (e, n, t, i) {
            void 0 === e && (e = a.EGAAdAction.Undefined),
              ...
              o.performTaskOnGAThread(function () {
                m.isSdkReady(!0, !0, "Could not add ad event") &&
                  f.addAdEvent(e, n, t, i, a.EGAAdError.Undefined, 0, !1, {});
              });
          }),
          (m.setEnabledInfoLog = function (e) {
            void 0 === e && (e = !1),
              o.performTaskOnGAThread(function () {
                e
                  ? (d.setInfoLog(e), d.i("Info logging enabled"))
                  : (d.i("Info logging disabled"), d.setInfoLog(e));
              });
          }),
          (m.setEnabledVerboseLog = function (e) {
            void 0 === e && (e = !1),
              o.performTaskOnGAThread(function () {
                e
                  ? (d.setVerboseLog(e), d.i("Verbose logging enabled"))
                  : (d.i("Verbose logging disabled"), d.setVerboseLog(e));
              });
          }),
          (m.setEnabledManualSessionHandling = function (e) {
            void 0 === e && (e = !1),
              o.performTaskOnGAThread(function () {
                l.setManualSessionHandling(e);
              });
          }),
          (m.setEnabledEventSubmission = function (e) {
            void 0 === e && (e = !1),
              o.performTaskOnGAThread(function () {
                e
                  ? (l.setEnabledEventSubmission(e),
                    d.i("Event submission enabled"))
                  : (d.i("Event submission disabled"),
                    l.setEnabledEventSubmission(e));
              });
          }),
          (m.setCustomDimension01 = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                i.validateDimension01(e, l.getAvailableCustomDimensions01())
          ...
          (m.setCustomDimension02 = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                i.validateDimension02(e, l.getAvailableCustomDimensions02())
          ...
          (m.setCustomDimension03 = function (e) {
            void 0 === e && (e = ""),
              o.performTaskOnGAThread(function () {
                i.validateDimension03(e, l.getAvailableCustomDimensions03())
          ...
          (m.getRemoteConfigsValueAsString = function (e, n) {
            return (
              void 0 === n && (n = null), l.getConfigurationStringValue(e, n)
            );
          }),
          (m.isRemoteConfigsReady = function () {
            return l.isRemoteConfigsReady();
          }),
          (m.addRemoteConfigsListener = function (e) {
            l.addRemoteConfigsListener(e);
          }),
          (m.removeRemoteConfigsListener = function (e) {
            l.removeRemoteConfigsListener(e);
          }),
          (m.getRemoteConfigsContentAsString = function () {
            return l.getRemoteConfigsContentAsString();
          }),
          (m.getABTestingId = function () {
            return l.getABTestingId();
          }),
          (m.getABTestingVariantId = function () {
            return l.getABTestingVariantId();
          }),
          (m.internalInitialize = function () {
            l.ensurePersistedStates(),
              u.setItem(l.getGameKey(), l.DefaultUserIdKey, l.getDefaultId()),
              l.setInitialized(!0),
              m.newSession(),
              l.isEnabled() && o.ensureEventQueueIsRunning();
          }),
          (m.newSession = function () {
            d.i("Starting a new session."),
              l.validateAndFixCurrentDimensions(),
              e.instance.requestInit(
                l.instance.configsHash,
                m.startNewSessionCallback
              );
          }),
          (m.startNewSessionCallback = function (e, n) {
            if ((e !== v.Ok && e !== v.Created) || !n)
              e == v.Unauthorized
                ? (d.w("Initialize SDK failed - Unauthorized"),
                  (l.instance.initAuthorized = !1))
                : (e === v.NoResponse || e === v.RequestTimeout
                    ? d.i(
                        "Init call (session start) failed - no response. Could be offline or timeout."
                      )
                    : e === v.BadResponse ||
                      e === v.JsonEncodeFailed ||
                      e === v.JsonDecodeFailed
                    ? d.i(
                        "Init call (session start) failed - bad response. Could be bad response from proxy or GA servers."
                      )
                    : (e !== v.BadRequest && e !== v.UnknownResponseCode) ||
                      d.i(
                        "Init call (session start) failed - bad request or unknown response."
                      ),
                  null == l.instance.sdkConfig
                    ? null != l.instance.sdkConfigCached
                      ? (d.i(
                          "Init call (session start) failed - using cached init values."
                        ),
                        (l.instance.sdkConfig = l.instance.sdkConfigCached))
                      : (d.i(
                          "Init call (session start) failed - using default init values."
                        ),
                        (l.instance.sdkConfig = l.instance.sdkConfigDefault))
                    : d.i(
                        "Init call (session start) failed - using cached init values."
                      ),
                  (l.instance.initAuthorized = !0));
            else {
              var t = 0;
              if (n.server_ts) {
                var i = n.server_ts;
              ...
              if (((n.time_offset = t), e != v.Created)) {
                ...
                r.configs && (n.configs = r.configs),
                  r.configs_hash && (n.configs_hash = r.configs_hash),
                  r.ab_id && (n.ab_id = r.ab_id),
                  r.ab_variant_id && (n.ab_variant_id = r.ab_variant_id);
              }
              (l.instance.configsHash = n.configs_hash ? n.configs_hash : ""),
                (l.instance.abId = n.ab_id ? n.ab_id : ""),
                (l.instance.abVariantId = n.ab_variant_id
                  ? n.ab_variant_id
                  : ""),
                u.setItem(
                  l.getGameKey(),
                  l.SdkConfigCachedKey,
                  g.encode64(JSON.stringify(n))
                ),
                (l.instance.sdkConfigCached = n),
                (l.instance.sdkConfig = n),
                (l.instance.initAuthorized = !0);
            }
            if (
              ((l.instance.clientServerTimeOffset = l.getSdkConfig().time_offset
                ? l.getSdkConfig().time_offset
                : 0),
              l.populateConfigurations(l.getSdkConfig()),
              !l.isEnabled())
            )
              return (
                d.w("Could not start session: SDK is disabled."),
                void o.stopEventQueue()
              );
            o.ensureEventQueueIsRunning();
            var s = g.createGuid();
            (l.instance.sessionId = s),
              (l.instance.sessionStart = l.getClientTsAdjusted()),
              f.addSessionStartEvent();
            var a = o.getTimedBlockById(m.initTimedBlockId);
            null != a && (a.running = !1), (m.initTimedBlockId = -1);
          }),
          (m.resumeSessionAndStartQueue = function () {
            l.isInitialized() &&
              (d.i("Resuming session."),
              l.sessionIsStarted() || m.newSession());
          }),
          (m.isSdkReady = function (e, n, t) {
            return (
              ...
              t && (t += ": "),
              e && !l.isInitialized()
                ? (n && d.w(t + "SDK is not initialized"), !1)
                : e && !l.isEnabled()
                ? (n && d.w(t + "SDK is disabled"), !1)
                : !(
                    e &&
                    !l.sessionIsStarted() &&
                    (n && d.w(t + "Session has not started yet"), 1)
                  )
            );
          }),
