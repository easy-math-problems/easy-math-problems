function createUnityInstance(r, n, l) {
  ...
  function g(e, r) {
    if ("symbolsUrl" != e) {
      ...
      for (e in c.downloadProgress) {
        ...
        i++,
          n.lengthComputable
            ? ((t += n.loaded), (o += n.total), a++)
            : n.finished || s++;
      }
      l(0.9 * (i ? (i - s - (o ? (a * (o - t)) / o : 0)) / i : 0));
    }
  }
  function p() {
    new Promise(function (i, e) {
      ...
      (a.src = c.frameworkUrl),
        (a.onload = function () {
          ...
          (unityFramework = null), (a.onload = null), i(o);
        }),
  ...
  return (
    (c.SystemInfo = (function () {
      ...
      "Safari" == e && (r = a("Version/(.*?) ", o, 1)),
        "Internet Explorer" == e && (r = a("rv:(.*?)\\)? ", o, 1) || r);
      for (
        var l = [
            ["Windows (.*?)[;)]", "Windows"],
    ...
    (c.readBodyWithProgress = function (i, a, s) {
    ...
    (c.fetchWithProgress = function (e, r) {
      var n = function () {};
      // if (!e.endsWith(".hash") || !e.endsWith("catalog.bundle")){
      //   e = e.replace("https://blocops.io/", "");
      // } else {
      //   e = proxyurl(e);
      // }
      e = e.replace("https://blocops.io/", "");
