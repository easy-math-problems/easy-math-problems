let proxapi = "https://juststudy.uk"//window.location.protocol + "//" + window.location.host;//'http://127.0.0.1:8088'
async function proxyfetch(url) {
  return await fetch(proxapi + "/proxy?url=" + encodeURIComponent(url));
}
async function proxyurl(url){
  return proxapi + "/proxy?url=" + encodeURIComponent(url);
}
function unityFramework(Module) {
  ...
  function _InitSDK(version) {
    ...
    var initOptions = {
      wrapper: { engine: "unity", sdkVersion: window.unityStringify(version) },
    };
  ...
  function _JS_Eval_OpenURL(ptr) {
    var str = UTF8ToString(ptr);
    console.log("over here tryna open window. string was ", str)
  ...
  function _JS_SystemInfo_GetDocumentURL(buffer, bufferSize) {
    if (buffer) stringToUTF8("https://blocops.io", buffer, bufferSize);
    return lengthBytesUTF8("https://blocops.io");
  }
  ...
  function _JS_SystemInfo_GetStreamingAssetsURL(buffer, bufferSize) {
    console.log("here ", Module.streamingAssetsUrl)
  ...
  function _JS_WebPage_InitSocialLink(id) {
    window.GameEvent_InitSocialLink(Pointer_stringify(id));
  }
  function _JS_WebPage_InitSocialLogin(id) {
    window.GameEvent_InitSocialLogin(Pointer_stringify(id));
  }
  var wr = {
    requests: {},
    responses: {},
  ...
  function _JS_WebRequest_Send(
    ...
    try {
      ...
      // let stripped = originalUrl.replace(/^https?:\/\/[^/]+/, "");
      // let newUrl = "https://blocop.io" + stripped;
      // requestOptions.url = proxyurl(newUrl);

      console.log("THE REQUEST URL IS ", requestOptions.url);
  ...
  var FS = {
    ...
    createLazyFile: function (parent, name, url, canRead, canWrite) {
      ...
      url = proxyurl("https://blocops.com/" + stripped);
  ...
  function _exitFullscreen_FullscreenWebGL(callback) {
    document.documentElement.addEventListener(
      "pointerup",
      function () {
        const exitFullscreen =
          document.exitFullscreen.bind(document) ||
          document.mozExitFullscreen.bind(document) ||
  ...
  function _isFullscreenSupported_FullscreenWebGL() {
    return document.fullscreenEnabled;
  }
  function _isFullscreen_FullscreenWebGL() {
    document.fullscreenElement =
      document.fullscreenElement ||
      document.mozFullscreenElement ||
  ...
  function _requestFullscreen_FullscreenWebGL(callback, option) {
    ...
    document.documentElement.addEventListener(
      ...
      function () {
        ...
        const requestFullscreen =
          ...
          canvas.msRequestFullscreen.bind(canvas);
        requestFullscreen({ navigationUI: option })
          .then(function () {
            callback !== 0 && Module.dynCall_vi(callback, 0);
          })
          .catch(function (error) {
  ...
  function _subscribeToFullscreenchangedEvent_FullscreenWebGL(callback) {
    Module["FullscreenWebGL"].fullscreenchangeCallback = callback;
    document.addEventListener(
      "fullscreenchange",
      Module["FullscreenWebGL"].fullscreenchange
    );
  }
  function _time(ptr) {
  ...
  var asmLibraryArg = {
    ...
    ni: _GetGameSettingsJSONSDK,
    mi: _GetInviteLinkParamSDK,
    li: _GetIsQaToolSDK,
    ki: _GetSystemInfoSDK,
    ji: _GetUserSDK,
    ii: _GetUserTokenSDK,
    hi: _GetXsollaUserTokenSDK,
    gi: _HappyTimeSDK,
    fi: _HideInviteButtonSDK,
    ei: _InitSDK,
    di: _IsUserAccountAvailableSDK,
    ci: _JS_Accelerometer_IsRunning,
    Cc: _JS_Accelerometer_Start,
    Bc: _JS_Accelerometer_Stop,
    bi: _JS_Cursor_SetImage,
    Ac: _JS_Cursor_SetShow,
    Za: _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
    ai: _JS_DOM_UnityCanvasSelector,
    $h: _JS_Eval_EvalJS,
    _h: _JS_Eval_OpenURL,
    Zh: _JS_FileSystem_Initialize,
    Z: _JS_FileSystem_Sync,
    Yh: _JS_GravitySensor_IsRunning,
    zc: _JS_GravitySensor_Start,
    yc: _JS_GravitySensor_Stop,
    Xh: _JS_GuardAgainstJsExceptions,
    Wh: _JS_Gyroscope_IsRunning,
    xc: _JS_Gyroscope_Start,
    wc: _JS_Gyroscope_Stop,
    Vh: _JS_Init_ContextMenuHandler,
    Uh: _JS_LinearAccelerationSensor_IsRunning,
    vc: _JS_LinearAccelerationSensor_Start,
    uc: _JS_LinearAccelerationSensor_Stop,
    Th: _JS_Log_Dump,
    Sh: _JS_Log_StackTrace,
    Rh: _JS_OrientationSensor_IsRunning,
    tc: _JS_OrientationSensor_Start,
    sc: _JS_OrientationSensor_Stop,
    rc: _JS_RequestDeviceSensorPermissionsOnTouch,
    Qh: _JS_RunQuitCallbacks,
    Ph: _JS_ScreenOrientation_DeInit,
    Oh: _JS_ScreenOrientation_Init,
    da: _JS_ScreenOrientation_Lock,
    Nh: _JS_Sound_Create_Channel,
    Mh: _JS_Sound_GetData,
    Y: _JS_Sound_GetLength,
    Lh: _JS_Sound_GetLoadState,
    Kh: _JS_Sound_GetMetaData,
    Jh: _JS_Sound_Init,
    Ih: _JS_Sound_IsStopped,
    qc: _JS_Sound_Load,
    pc: _JS_Sound_Load_PCM,
    Ya: _JS_Sound_Play,
    Aa: _JS_Sound_ReleaseInstance,
    oc: _JS_Sound_ResumeIfNeeded,
    Hh: _JS_Sound_Set3D,
    Gh: _JS_Sound_SetListenerOrientation,
    Fh: _JS_Sound_SetListenerPosition,
    nc: _JS_Sound_SetLoop,
    mc: _JS_Sound_SetLoopPoints,
    za: _JS_Sound_SetPaused,
    ca: _JS_Sound_SetPitch,
    Eh: _JS_Sound_SetPosition,
    Dh: _JS_Sound_SetVolume,
    ya: _JS_Sound_Stop,
    lc: _JS_SystemInfo_GetBrowserName,
    kc: _JS_SystemInfo_GetBrowserVersionString,
    xa: _JS_SystemInfo_GetCanvasClientSize,
    jc: _JS_SystemInfo_GetDocumentURL,
    ic: _JS_SystemInfo_GetGPUInfo,
    hc: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Xa: _JS_SystemInfo_GetMemory,
    gc: _JS_SystemInfo_GetOS,
    fc: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    Ch: _JS_SystemInfo_GetScreenSize,
    ec: _JS_SystemInfo_GetStreamingAssetsURL,
    Bh: _JS_SystemInfo_HasAstcHdr,
    dc: _JS_SystemInfo_HasCursorLock,
    Ah: _JS_SystemInfo_HasFullscreen,
    wa: _JS_SystemInfo_HasWebGL,
    zh: _JS_SystemInfo_IsMobile,
    yh: _JS_UnityEngineShouldQuit,
    xh: _JS_WebPage_InitSocialLink,
    wh: _JS_WebPage_InitSocialLogin,
    vh: _JS_WebRequest_Abort,
    uh: _JS_WebRequest_Create,
    th: _JS_WebRequest_GetResponseMetaData,
    sh: _JS_WebRequest_GetResponseMetaDataLengths,
    Wa: _JS_WebRequest_Release,
    rh: _JS_WebRequest_Send,
    qh: _JS_WebRequest_SetRedirectLimit,
    ph: _JS_WebRequest_SetRequestHeader,
    oh: _JS_WebRequest_SetTimeout,
    nh: _RequestAdSDK,
    mh: _RequestBannersSDK,
    lh: _RequestInviteUrlSDK,
    kh: _ShowAccountLinkPromptSDK,
    jh: _ShowAuthPromptSDK,
    ih: _ShowInviteButtonSDK,
    cc: _SocketClose,
    hh: _SocketCreate,
    gh: _SocketError,
    fh: _SocketRecv,
    bc: _SocketRecvLength,
    eh: _SocketSend,
    ac: _SocketState,
    dh: _SyncFiles,
    ch: _SyncUnityGameDataSDK,
    bh: _WindowAlert,
    ...
    ah: ___cxa_find_matching_catch_4,
    Va: ___cxa_free_exception,
    $g: ___cxa_rethrow,
    X: ___cxa_throw,
    _g: ___gmtime_r,
    Zg: ___localtime_r,
    i: ___resumeException,
    Wg: ___sys__newselect,
    Gg: ___sys_accept4,
    Kg: ___sys_access,
    Jg: ___sys_bind,
    Vg: ___sys_chmod,
    ...
    I: ___sys_fcntl64,
    Og: ___sys_fstat64,
    Qg: ___sys_ftruncate64,
    Tg: ___sys_getcwd,
    Mg: ___sys_getdents64,
    Zb: ___sys_getegid32,
    _b: ___sys_geteuid32,
    Cg: ___sys_getpeername,
    Ua: ___sys_getpid,
    rg: ___sys_getrusage,
    Dg: ___sys_getsockname,
    Fg: ___sys_getsockopt,
    Ng: ___sys_getuid32,
    Xb: ___sys_ioctl,
    Hg: ___sys_listen,
    Pg: ___sys_lstat64,
    ...
    Ag: ___sys_sendmsg,
    Bg: ___sys_sendto,
    Eg: ___sys_setsockopt,
    xg: ___sys_shutdown,
    Yb: ___sys_socket,
    $b: ___sys_stat64,
    Lg: ___sys_statfs64,
    Rg: ___sys_truncate64,
    Xg: ___sys_uname,
    Yg: ___sys_unlink,
    w: _abort,
    C: _clock,
    ...
    Tb: _dlopen,
    jg: _dlsym,
    Ra: _emscripten_asm_const_int_sync_on_main_thread,
    ig: _emscripten_cancel_main_loop,
    hg: _emscripten_clear_interval,
    gg: _emscripten_exit_fullscreen,
    fg: _emscripten_exit_pointerlock,
    eg: _emscripten_get_canvas_element_size,
    dg: _emscripten_get_fullscreen_status,
    Sb: _emscripten_get_gamepad_status,
    cg: _emscripten_get_heap_max,
    G: _emscripten_get_now,
    Rb: _emscripten_get_num_gamepads,
    bg: _emscripten_html5_remove_all_event_listeners,
    ag: _emscripten_is_webgl_context_lost,
    A: _emscripten_log,
    D: _emscripten_longjmp,
    $f: _emscripten_memcpy_big,
    _f: _emscripten_request_fullscreen,
    Zf: _emscripten_request_pointerlock,
    Yf: _emscripten_resize_heap,
    Qb: _emscripten_sample_gamepad_data,
    Pb: _emscripten_set_blur_callback_on_thread,
    Qa: _emscripten_set_canvas_element_size,
    Xf: _emscripten_set_focus_callback_on_thread,
    Wf: _emscripten_set_fullscreenchange_callback_on_thread,
    Ob: _emscripten_set_gamepadconnected_callback_on_thread,
    Nb: _emscripten_set_gamepaddisconnected_callback_on_thread,
    Vf: _emscripten_set_interval,
    ...
    Uf: _emscripten_set_main_loop,
    Tf: _emscripten_set_main_loop_timing,
    Mb: _emscripten_set_mousedown_callback_on_thread,
    Lb: _emscripten_set_mousemove_callback_on_thread,
    Kb: _emscripten_set_mouseup_callback_on_thread,
    Sf: _emscripten_set_pointerlockchange_callback_on_thread,
    Jb: _emscripten_set_touchcancel_callback_on_thread,
    Ib: _emscripten_set_touchend_callback_on_thread,
    Hb: _emscripten_set_touchmove_callback_on_thread,
    Gb: _emscripten_set_touchstart_callback_on_thread,
    Fb: _emscripten_set_wheel_callback_on_thread,
    Rf: _emscripten_thread_sleep,
    Qf: _emscripten_webgl_create_context,
    Pf: _emscripten_webgl_destroy_context,
    ra: _emscripten_webgl_enable_extension,
    Of: _emscripten_webgl_get_current_context,
    Nf: _emscripten_webgl_init_context_attributes,
    qa: _emscripten_webgl_make_context_current,
    og: _environ_get,
    ng: _environ_sizes_get,
    x: _exit,
    Mf: _exitFullscreen_FullscreenWebGL,
    R: _fd_close,
    Wb: _fd_fdstat_get,
    Vb: _fd_read,
    ud: _fd_seek,
    ...
    Ef: _glBindBuffer,
    Df: _glBindBufferBase,
    Cf: _glBindBufferRange,
    Bf: _glBindFramebuffer,
    Af: _glBindRenderbuffer,
    zf: _glBindSampler,
    yf: _glBindTexture,
    xf: _glBindTransformFeedback,
    wf: _glBindVertexArray,
    Cb: _glBlendEquation,
    Bb: _glBlendEquationSeparate,
    Ab: _glBlendFuncSeparate,
    vf: _glBlitFramebuffer,
    uf: _glBufferData,
    tf: _glBufferSubData,
    sf: _glCheckFramebufferStatus,
    rf: _glClear,
    qf: _glClearBufferfi,
    pf: _glClearBufferfv,
    ...
    mf: _glClearDepthf,
    lf: _glClearStencil,
    td: _glClientWaitSync,
    Pa: _glColorMask,
    kf: _glCompileShader,
    jf: _glCompressedTexImage2D,
    hf: _glCompressedTexImage3D,
    gf: _glCompressedTexSubImage2D,
    ff: _glCompressedTexSubImage3D,
    ef: _glCopyBufferSubData,
    df: _glCopyTexImage2D,
    zb: _glCopyTexSubImage2D,
    cf: _glCreateProgram,
    bf: _glCreateShader,
    af: _glCullFace,
    $e: _glDeleteBuffers,
    _e: _glDeleteFramebuffers,
    Ze: _glDeleteProgram,
    Oa: _glDeleteQueries,
    Ye: _glDeleteRenderbuffers,
    Xe: _glDeleteSamplers,
    We: _glDeleteShader,
    yb: _glDeleteSync,
    Ve: _glDeleteTextures,
    Ue: _glDeleteTransformFeedbacks,
    Te: _glDeleteVertexArrays,
    ma: _glDepthFunc,
    la: _glDepthMask,
    Se: _glDetachShader,
    Re: _glDisable,
    Qe: _glDisableVertexAttribArray,
    Pe: _glDrawArrays,
    Oe: _glDrawArraysInstanced,
    Ne: _glDrawBuffers,
    Me: _glDrawElements,
    Le: _glDrawElementsInstanced,
    Ke: _glEnable,
    Je: _glEnableVertexAttribArray,
    xb: _glEndQuery,
    Ie: _glEndTransformFeedback,
    wb: _glFenceSync,
    He: _glFinish,
    Ge: _glFlush,
    Fe: _glFlushMappedBufferRange,
    K: _glFramebufferRenderbuffer,
    H: _glFramebufferTexture2D,
    ka: _glFramebufferTextureLayer,
    ja: _glFrontFace,
    Ee: _glGenBuffers,
    De: _glGenFramebuffers,
    vb: _glGenQueries,
    Ce: _glGenRenderbuffers,
    Be: _glGenSamplers,
    Ae: _glGenTextures,
    ze: _glGenTransformFeedbacks,
    ye: _glGenVertexArrays,
    xe: _glGenerateMipmap,
    we: _glGetActiveAttrib,
    Na: _glGetActiveUniform,
    Ma: _glGetActiveUniformBlockName,
    W: _glGetActiveUniformBlockiv,
    V: _glGetActiveUniformsiv,
    ve: _glGetAttribLocation,
    ue: _glGetBufferSubData,
    te: _glGetError,
    se: _glGetFramebufferAttachmentParameteriv,
    re: _glGetIntegeri_v,
    ia: _glGetIntegerv,
    qe: _glGetInternalformativ,
    ub: _glGetProgramBinary,
    pe: _glGetProgramInfoLog,
    O: _glGetProgramiv,
    oe: _glGetQueryObjectuiv,
    ne: _glGetQueryiv,
    me: _glGetRenderbufferParameteriv,
    le: _glGetShaderInfoLog,
    tb: _glGetShaderPrecisionFormat,
    ke: _glGetShaderSource,
    je: _glGetShaderiv,
    ie: _glGetString,
    he: _glGetStringi,
    ge: _glGetTexParameteriv,
    fe: _glGetUniformBlockIndex,
    La: _glGetUniformIndices,
    ba: _glGetUniformLocation,
    sb: _glGetUniformiv,
    ee: _glGetVertexAttribiv,
    Ka: _glInvalidateFramebuffer,
    de: _glIsEnabled,
    ce: _glIsVertexArray,
    be: _glLinkProgram,
    ae: _glMapBufferRange,
    $d: _glPixelStorei,
    rb: _glPolygonOffset,
    qb: _glProgramBinary,
    _d: _glProgramParameteri,
    Zd: _glReadBuffer,
    U: _glReadPixels,
    Yd: _glRenderbufferStorage,
    Xd: _glRenderbufferStorageMultisample,
    Wd: _glSamplerParameteri,
    Ja: _glScissor,
    Vd: _glShaderSource,
    Ud: _glStencilFuncSeparate,
    Td: _glStencilMask,
    Sd: _glStencilOpSeparate,
    Rd: _glTexImage2D,
    Qd: _glTexImage3D,
    Pd: _glTexParameterf,
    Ia: _glTexParameteri,
    Od: _glTexParameteriv,
    Nd: _glTexStorage2D,
    Md: _glTexStorage3D,
    Ld: _glTexSubImage2D,
    Kd: _glTexSubImage3D,
    Jd: _glTransformFeedbackVaryings,
    pb: _glUniform1fv,
    ha: _glUniform1i,
    ob: _glUniform1iv,
    nb: _glUniform1uiv,
    ...
    fb: _glUniformMatrix3fv,
    ga: _glUniformMatrix4fv,
    Id: _glUnmapBuffer,
    Hd: _glUseProgram,
    Gd: _glValidateProgram,
    Fd: _glVertexAttrib4f,
    Ed: _glVertexAttrib4fv,
    Dd: _glVertexAttribIPointer,
    Cd: _glVertexAttribPointer,
    Fa: _glViewport,
    Bd: invoke_dii,
    Ad: invoke_diii,
    zd: invoke_fi,
    ...
    Ea: invoke_iiiiiiiiiii,
    yd: invoke_iiiiiiiiiiiii,
    ...
    Qc: invoke_viiji,
    Pc: invoke_viijii,
    Oc: invoke_viijiiiiii,
    Nc: invoke_viijiiijiiii,
    Mc: invoke_viji,
    Lc: invoke_vijii,
    Kc: invoke_vijiii,
    Jc: invoke_vijjji,
    ...
    Hc: invoke_vjiiiii,
    Gc: invoke_vjjjiiii,
    wd: _isFullscreenSupported_FullscreenWebGL,
    vd: _isFullscreen_FullscreenWebGL,
    j: _llvm_eh_typeid_for,
    $a: _mktime,
    Fc: _requestFullscreen_FullscreenWebGL,
    v: _setTempRet0,
    Da: _sigaction,
    Ca: _sigemptyset,
    Ba: _strftime,
    Ec: _subscribeToFullscreenchangedEvent_FullscreenWebGL,
    L: _time,
    _a: _utime,
  };
  var asm = createWasm();
  ...
  var _ReleaseKeys = (Module["_ReleaseKeys"] = function () {
    return (_ReleaseKeys = Module["_ReleaseKeys"] = Module["asm"]["Ai"]).apply(
      null,
      arguments
    );
  });
  ...
  var _SendMessage = (Module["_SendMessage"] = function () {
    return (_SendMessage = Module["_SendMessage"] = Module["asm"]["Di"]).apply(
      null,
      arguments
    );
  });
  ...
  var _main = (Module["_main"] = function () {
    return (_main = Module["_main"] = Module["asm"]["Fi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _htonl = (Module["_htonl"] = function () {
    return (_htonl = Module["_htonl"] = Module["asm"]["Hi"]).apply(
      null,
      arguments
    );
  });
  var _htons = (Module["_htons"] = function () {
    return (_htons = Module["_htons"] = Module["asm"]["Ii"]).apply(
      null,
      arguments
    );
  });
  var _ntohs = (Module["_ntohs"] = function () {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["Ji"]).apply(
      null,
      arguments
    );
  });
  var __get_tzname = (Module["__get_tzname"] = function () {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["Ki"]).apply(
      null,
      arguments
    );
  });
  ...
  var stackSave = (Module["stackSave"] = function () {
    return (stackSave = Module["stackSave"] = Module["asm"]["Ni"]).apply(
      null,
      arguments
    );
  });
  var stackRestore = (Module["stackRestore"] = function () {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["Oi"]).apply(
      null,
      arguments
    );
  });
  var stackAlloc = (Module["stackAlloc"] = function () {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Pi"]).apply(
      null,
      arguments
    );
  });
  var _setThrew = (Module["_setThrew"] = function () {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["Qi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _malloc = (Module["_malloc"] = function () {
    return (_malloc = Module["_malloc"] = Module["asm"]["Ti"]).apply(
      null,
      arguments
    );
  });
  var _free = (Module["_free"] = function () {
    return (_free = Module["_free"] = Module["asm"]["Ui"]).apply(
      null,
      arguments
    );
  });
  var _memalign = (Module["_memalign"] = function () {
    return (_memalign = Module["_memalign"] = Module["asm"]["Vi"]).apply(
      null,
      arguments
    );
  });
  var _memset = (Module["_memset"] = function () {
    return (_memset = Module["_memset"] = Module["asm"]["Wi"]).apply(
      null,
      arguments
    );
  });
  var _strlen = (Module["_strlen"] = function () {
    return (_strlen = Module["_strlen"] = Module["asm"]["Xi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vii = (Module["dynCall_vii"] = function () {
    return (dynCall_vii = Module["dynCall_vii"] = Module["asm"]["_i"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ii = (Module["dynCall_ii"] = function () {
    return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["aj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiii = (Module["dynCall_iiii"] = function () {
    return (dynCall_iiii = Module["dynCall_iiii"] = Module["asm"]["bj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jiji = (Module["dynCall_jiji"] = function () {
    return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["cj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vi = (Module["dynCall_vi"] = function () {
    return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["dj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viii = (Module["dynCall_viii"] = function () {
    return (dynCall_viii = Module["dynCall_viii"] = Module["asm"]["fj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_i = (Module["dynCall_i"] = function () {
    return (dynCall_i = Module["dynCall_i"] = Module["asm"]["gj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iij = (Module["dynCall_iij"] = function () {
    return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["pj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jii = (Module["dynCall_jii"] = function () {
    return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["rj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["tj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiii = (Module["dynCall_fiii"] = function () {
    return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["vj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["wj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fifi = (Module["dynCall_fifi"] = function () {
    return (dynCall_fifi = Module["dynCall_fifi"] = Module["asm"]["xj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ji = (Module["dynCall_ji"] = function () {
    return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["Cj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijji = (Module["dynCall_ijji"] = function () {
    return (dynCall_ijji = Module["dynCall_ijji"] = Module["asm"]["Jj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jjji = (Module["dynCall_jjji"] = function () {
    return (dynCall_jjji = Module["dynCall_jjji"] = Module["asm"]["Kj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viij = (Module["dynCall_viij"] = function () {
    return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["Lj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vifi = (Module["dynCall_vifi"] = function () {
    return (dynCall_vifi = Module["dynCall_vifi"] = Module["asm"]["Nj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dii = (Module["dynCall_dii"] = function () {
    return (dynCall_dii = Module["dynCall_dii"] = Module["asm"]["Yj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_diii = (Module["dynCall_diii"] = function () {
    return (dynCall_diii = Module["dynCall_diii"] = Module["asm"]["_j"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viiiiiifiiif = (Module["dynCall_viiiiiifiiif"] = function () {
    return (dynCall_viiiiiifiiif = Module["dynCall_viiiiiifiiif"] =
  ...
  var dynCall_fi = (Module["dynCall_fi"] = function () {
    return (dynCall_fi = Module["dynCall_fi"] = Module["asm"]["gk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_j = (Module["dynCall_j"] = function () {
    return (dynCall_j = Module["dynCall_j"] = Module["asm"]["zk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jijj = (Module["dynCall_jijj"] = function () {
    return (dynCall_jijj = Module["dynCall_jijj"] = Module["asm"]["Ak"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vji = (Module["dynCall_vji"] = function () {
    return (dynCall_vji = Module["dynCall_vji"] = Module["asm"]["Ck"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iji = (Module["dynCall_iji"] = function () {
    return (dynCall_iji = Module["dynCall_iji"] = Module["asm"]["Fk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viji = (Module["dynCall_viji"] = function () {
    return (dynCall_viji = Module["dynCall_viji"] = Module["asm"]["Gk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viifffffii = (Module["dynCall_viifffffii"] = function () {
    return (dynCall_viifffffii = Module["dynCall_viifffffii"] =
      Module["asm"]["Nk"]).apply(null, arguments);
  });
  ...
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["Pk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["Qk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iffi = (Module["dynCall_iffi"] = function () {
    return (dynCall_iffi = Module["dynCall_iffi"] = Module["asm"]["Zk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiiffffi = (Module["dynCall_iiiffffi"] = function () {
    return (dynCall_iiiffffi = Module["dynCall_iiiffffi"] =
  ...
  var dynCall_viiiiiifffffifi = (Module["dynCall_viiiiiifffffifi"] =
    function () {
      return (dynCall_viiiiiifffffifi = Module["dynCall_viiiiiifffffifi"] =
  ...
  var dynCall_ijii = (Module["dynCall_ijii"] = function () {
    return (dynCall_ijii = Module["dynCall_ijii"] = Module["asm"]["ql"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viiiiiiiifii = (Module["dynCall_viiiiiiiifii"] = function () {
    return (dynCall_viiiiiiiifii = Module["dynCall_viiiiiiiifii"] =
  ...
  var dynCall_vifffifi = (Module["dynCall_vifffifi"] = function () {
    return (dynCall_vifffifi = Module["dynCall_vifffifi"] =
  ...
  var dynCall_viiiffiifiiffififi = (Module["dynCall_viiiffiifiiffififi"] =
    function () {
      return (dynCall_viiiffiifiiffififi = Module[
        "dynCall_viiiffiifiiffififi"
      ] =
        Module["asm"]["vl"]).apply(null, arguments);
    });
  var dynCall_vifffffifi = (Module["dynCall_vifffffifi"] = function () {
    return (dynCall_vifffffifi = Module["dynCall_vifffffifi"] =
  ...
  var dynCall_fiffffffffi = (Module["dynCall_fiffffffffi"] = function () {
    return (dynCall_fiffffffffi = Module["dynCall_fiffffffffi"] =
      Module["asm"]["Cl"]).apply(null, arguments);
  });
  ...
  var dynCall_viiiifiiifi = (Module["dynCall_viiiifiiifi"] = function () {
    return (dynCall_viiiifiiifi = Module["dynCall_viiiifiiifi"] =
      Module["asm"]["Fl"]).apply(null, arguments);
  });
  ...
  var dynCall_viiffiiffffiiiiffiifii = (Module[
    "dynCall_viiffiiffffiiiiffiifii"
  ] = function () {
    return (dynCall_viiffiiffffiiiiffiifii = Module[
      "dynCall_viiffiiffffiiiiffiifii"
    ] =
      Module["asm"]["Jl"]).apply(null, arguments);
  });
  var dynCall_viiffiifffiiiiffiifii = (Module["dynCall_viiffiifffiiiiffiifii"] =
    function () {
      return (dynCall_viiffiifffiiiiffiifii = Module[
        "dynCall_viiffiifffiiiiffiifii"
      ] =
        Module["asm"]["Kl"]).apply(null, arguments);
    });
  var dynCall_viiffiiffffiiiiffiifiiii = (Module[
    "dynCall_viiffiiffffiiiiffiifiiii"
  ] = function () {
    return (dynCall_viiffiiffffiiiiffiifiiii = Module[
      "dynCall_viiffiiffffiiiiffiifiiii"
    ] =
      Module["asm"]["Ll"]).apply(null, arguments);
  });
  ...
  var dynCall_viiffiiffffiiiiffiifiii = (Module[
    "dynCall_viiffiiffffiiiiffiifiii"
  ] = function () {
    return (dynCall_viiffiiffffiiiiffiifiii = Module[
      "dynCall_viiffiiffffiiiiffiifiii"
    ] =
      Module["asm"]["Nl"]).apply(null, arguments);
  });
  var dynCall_iiiffiffiiiiii = (Module["dynCall_iiiffiffiiiiii"] = function () {
    return (dynCall_iiiffiffiiiiii = Module["dynCall_iiiffiffiiiiii"] =
      Module["asm"]["Ol"]).apply(null, arguments);
  });
  ...
  var dynCall_viifffiiiiffifii = (Module["dynCall_viifffiiiiffifii"] =
    function () {
      return (dynCall_viifffiiiiffifii = Module["dynCall_viifffiiiiffifii"] =
        Module["asm"]["Ql"]).apply(null, arguments);
    });
  var dynCall_iiiffiffiiiiiii = (Module["dynCall_iiiffiffiiiiiii"] =
    function () {
      return (dynCall_iiiffiffiiiiiii = Module["dynCall_iiiffiffiiiiiii"] =
        Module["asm"]["Rl"]).apply(null, arguments);
    });
  var dynCall_iiiiiifiiiiii = (Module["dynCall_iiiiiifiiiiii"] = function () {
    return (dynCall_iiiiiifiiiiii = Module["dynCall_iiiiiifiiiiii"] =
      Module["asm"]["Sl"]).apply(null, arguments);
  });
  ...
  var dynCall_iiiiiiiifiiiiiiii = (Module["dynCall_iiiiiiiifiiiiiiii"] =
    function () {
      return (dynCall_iiiiiiiifiiiiiiii = Module["dynCall_iiiiiiiifiiiiiiii"] =
        Module["asm"]["Wl"]).apply(null, arguments);
    });
  var dynCall_iiiiiiiifiiiiiii = (Module["dynCall_iiiiiiiifiiiiiii"] =
    function () {
      return (dynCall_iiiiiiiifiiiiiii = Module["dynCall_iiiiiiiifiiiiiii"] =
        Module["asm"]["Xl"]).apply(null, arguments);
    });
  var dynCall_iiiiiiifiiiiiii = (Module["dynCall_iiiiiiifiiiiiii"] =
    function () {
      return (dynCall_iiiiiiifiiiiiii = Module["dynCall_iiiiiiifiiiiiii"] =
        Module["asm"]["Yl"]).apply(null, arguments);
    });
  ...
  var dynCall_viiijjjji = (Module["dynCall_viiijjjji"] = function () {
    return (dynCall_viiijjjji = Module["dynCall_viiijjjji"] =
  ...
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["xm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiffiiffi = (Module["dynCall_iiffiiffi"] = function () {
    return (dynCall_iiffiiffi = Module["dynCall_iiffiiffi"] =
      Module["asm"]["ln"]).apply(null, arguments);
  });
  var dynCall_viiiiffiiffi = (Module["dynCall_viiiiffiiffi"] = function () {
    return (dynCall_viiiiffiiffi = Module["dynCall_viiiiffiiffi"] =
      Module["asm"]["mn"]).apply(null, arguments);
  });
  var dynCall_viiiiiffiiffi = (Module["dynCall_viiiiiffiiffi"] = function () {
    return (dynCall_viiiiiffiiffi = Module["dynCall_viiiiiffiiffi"] =
  ...
  var dynCall_idi = (Module["dynCall_idi"] = function () {
    return (dynCall_idi = Module["dynCall_idi"] = Module["asm"]["Gn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jjii = (Module["dynCall_jjii"] = function () {
    return (dynCall_jjii = Module["dynCall_jjii"] = Module["asm"]["Hn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vjii = (Module["dynCall_vjii"] = function () {
    return (dynCall_vjii = Module["dynCall_vjii"] = Module["asm"]["Sn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dji = (Module["dynCall_dji"] = function () {
    return (dynCall_dji = Module["dynCall_dji"] = Module["asm"]["Xn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jfi = (Module["dynCall_jfi"] = function () {
    return (dynCall_jfi = Module["dynCall_jfi"] = Module["asm"]["Yn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fji = (Module["dynCall_fji"] = function () {
    return (dynCall_fji = Module["dynCall_fji"] = Module["asm"]["Zn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fdi = (Module["dynCall_fdi"] = function () {
    return (dynCall_fdi = Module["dynCall_fdi"] = Module["asm"]["_n"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dfi = (Module["dynCall_dfi"] = function () {
    return (dynCall_dfi = Module["dynCall_dfi"] = Module["asm"]["$n"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jidi = (Module["dynCall_jidi"] = function () {
    return (dynCall_jidi = Module["dynCall_jidi"] = Module["asm"]["bo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iidi = (Module["dynCall_iidi"] = function () {
    return (dynCall_iidi = Module["dynCall_iidi"] = Module["asm"]["go"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dddi = (Module["dynCall_dddi"] = function () {
    return (dynCall_dddi = Module["dynCall_dddi"] = Module["asm"]["qo"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ddi = (Module["dynCall_ddi"] = function () {
    return (dynCall_ddi = Module["dynCall_ddi"] = Module["asm"]["ro"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ddii = (Module["dynCall_ddii"] = function () {
    return (dynCall_ddii = Module["dynCall_ddii"] = Module["asm"]["so"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jdii = (Module["dynCall_jdii"] = function () {
    return (dynCall_jdii = Module["dynCall_jdii"] = Module["asm"]["Bo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["Uo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["Xo"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["Yo"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ij = (Module["dynCall_ij"] = function () {
    return (dynCall_ij = Module["dynCall_ij"] = Module["asm"]["Zo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viif = (Module["dynCall_viif"] = function () {
    return (dynCall_viif = Module["dynCall_viif"] = Module["asm"]["$o"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vid = (Module["dynCall_vid"] = function () {
    return (dynCall_vid = Module["dynCall_vid"] = Module["asm"]["bp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiif = (Module["dynCall_iiif"] = function () {
    return (dynCall_iiif = Module["dynCall_iiif"] = Module["asm"]["gp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fif = (Module["dynCall_fif"] = function () {
    return (dynCall_fif = Module["dynCall_fif"] = Module["asm"]["hp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viff = (Module["dynCall_viff"] = function () {
    return (dynCall_viff = Module["dynCall_viff"] = Module["asm"]["ip"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiff = (Module["dynCall_fiff"] = function () {
    return (dynCall_fiff = Module["dynCall_fiff"] = Module["asm"]["np"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iif = (Module["dynCall_iif"] = function () {
    return (dynCall_iif = Module["dynCall_iif"] = Module["asm"]["Cp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vf = (Module["dynCall_vf"] = function () {
    return (dynCall_vf = Module["dynCall_vf"] = Module["asm"]["Np"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vff = (Module["dynCall_vff"] = function () {
    return (dynCall_vff = Module["dynCall_vff"] = Module["asm"]["Pp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fff = (Module["dynCall_fff"] = function () {
    return (dynCall_fff = Module["dynCall_fff"] = Module["asm"]["Qp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_f = (Module["dynCall_f"] = function () {
    return (dynCall_f = Module["dynCall_f"] = Module["asm"]["Sp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["Tp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiif = (Module["dynCall_fiif"] = function () {
    return (dynCall_fiif = Module["dynCall_fiif"] = Module["asm"]["Xp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viiiiiffiiff = (Module["dynCall_viiiiiffiiff"] = function () {
    return (dynCall_viiiiiffiiff = Module["dynCall_viiiiiffiiff"] =
      Module["asm"]["Zp"]).apply(null, arguments);
  });
  ...
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["$p"]).apply(
      null,
      arguments
    );
  });
  ...
  function invoke_viiiiiifiiif(
    ...
    var sp = stackSave();
    try {
      dynCall_viiiiiifiiif(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
    } catch (e) {
      stackRestore(sp);
      if (e !== e + 0 && e !== "longjmp") throw e;
      _setThrew(1, 0);
