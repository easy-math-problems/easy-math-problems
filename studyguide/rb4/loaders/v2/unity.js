!(function (n) {
                    ...
                    case 16:
                      for (
                        t = h(),
                          ...
                          o = 0;
                        o <= S.a.numScreenshots - 1;
                        o++
                      )
                        (i = document.createElement("div")),
                          (i.className = "bullet".concat(
                            0 === o ? " active" : ""
                          )),
  ...
  function (n, e, t) {
    ...
    function i(n, e) {
      for (var t = [], o = {}, i = 0; i < n.length; i++) {
        ...
        o[a] ? o[a].parts.push(d) : t.push((o[a] = { id: a, parts: [d] }));
      }
      return t;
    }
    function r(n, e) {
  ...
  function (n, e, t) {
    ...
    function o() {
      ...
      (d.style.marginLeft = "".concat(-0.5 * o.width, "px")),
        (d.style.marginTop = "".concat(-0.5 * o.height, "px"));
    }
    function i() {
      ...
      function c(n, e, o) {
        ...
        return function (r, a) {
          ...
          for (o.method = r, o.arg = a; ; ) {
            ...
            "throw" === d.type &&
              ((i = E), (o.method = "throw"), (o.arg = d.arg));
          }
        };
      }
      function l(n, e) {
        ...
        if ("throw" === i.type)
          return (e.method = "throw"), (e.arg = i.arg), (e.delegate = null), I;
        var r = i.arg;
        return r
          ? r.done
      ...
      return (
        ...
        (f.prototype = {
          ...
          delegateYield: function (n, e, t) {
            return (
              (this.delegate = { iterator: h(n), resultName: e, nextLoc: t }),
