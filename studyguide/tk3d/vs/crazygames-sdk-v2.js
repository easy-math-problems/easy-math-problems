  ...
  var t = {
      198: (t, e, n) => {
        ...
        var q,
          ...
          Z = (q = /[^.]+$/.exec((Q && Q.keys && Q.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + q
            : "",
          Y = K.toString,
          X = V.hasOwnProperty,
            ...
            a = (function (t) {
              ...
              if (kt(t))
                return (function (t) {
                  return (
                    "string" == typeof t ||
                    (!mt(t) && Et(t) && "[object String]" == H.call(t))
                  );
                })(t)
                  ? (function (t) {
                      return M.test(t);
        ...
        ((ot && yt(new ot(new ArrayBuffer(1))) != h) ||
          (ut && yt(new ut()) != s) ||
          (at && yt(at.resolve()) != c) ||
          (st && yt(new st()) != l) ||
          (ct && yt(new ct()) != f)) &&
              ...
              pn = (function t(e) {
                var n,
                  r = (e =
                    null == e
                      ? fe
                      : pn.defaults(fe.Object(), e, pn.pick(fe, ne))).Array,
                  it = e.Date,
                  mt = e.Error,
                  kt = e.Function,
                  It = e.Math,
                  ...
                  Gt = un(St.getPrototypeOf, St),
                  Kt = St.create,
                  Vt = Dt.propertyIsEnumerable,
                  Qt = Tt.splice,
                  Zt = Ft ? Ft.isConcatSpreadable : i,
                  Yt = Ft ? Ft.iterator : i,
                  Jt = Ft ? Ft.toStringTag : i,
                  te = (function () {
                    try {
                  ...
                  jn = Mn ? Mn.toString : i;
                function Bn(t) {
                  if (ta(t) && !Nu(t) && !(t instanceof qn)) {
                    if (t instanceof Fn) return t;
                    if (zt.call(t, "__wrapped__")) return Bo(t);
                  }
                  return new Fn(t);
                }
                var On = (function () {
                ...
                function Xn(t, e) {
                  return Wo(Ai(t), or(e, 0, t.length));
                }
                function Hn(t) {
                  return Wo(Ai(t));
                }
                function Jn(t, e, n) {
                  ((n !== i && !Ou(t[e], n)) || (n === i && !(e in t))) &&
                    rr(t, e, n);
                }
                function $n(t, e, n) {
                  var r = t[e];
                  (zt.call(t, e) && Ou(r, n) && (n !== i || e in t)) ||
                    rr(t, e, n);
                }
                function tr(t, e) {
                  for (var n = t.length; n--; ) if (Ou(t[n][0], e)) return n;
                  return -1;
                }
                function er(t, e, n, r) {
                  return (
                ...
                function ur(t, e, n, r, o, u) {
                  ...
                  var g = f ? i : (l ? (c ? eo : to) : c ? Pa : Da)(t);
                  return (
                    Ee(g || t, function (r, i) {
                      g && (r = t[(i = r)]), $n(a, i, ur(r, e, n, i, t, u));
                    }),
                    a
                  );
                }
                ...
                (Bn.templateSettings = {
                  ...
                  (Bn.prototype = Cn.prototype),
                  (Bn.prototype.constructor = Bn),
                  (Fn.prototype = On(Cn.prototype)),
                  (Fn.prototype.constructor = Fn),
                  (qn.prototype = On(Cn.prototype)),
                ...
                function Tr(t, e, n) {
                  var r =
                    null == (t = Eo(t, (e = gi(e, t)))) ? t : t[Uo(Yo(e))];
                ...
                function Pr(t, e, n, r) {
                  ...
                  for (; ++o < u; ) {
                    ...
                    if (a && s[2]) {
                      ...
                      if (!(d === i ? Dr(f, l, 3, r, h) : d)) return !1;
                    }
                  }
                  return !0;
                }
                ...
                function Br(t, e) {
                  return bo(t) && ko(e)
                    ...
                    : function (n) {
                        var r = Ea(n, t);
                        return r === i && r === e ? Aa(n, t) : Dr(e, r, 3);
                      };
                }
                ...
                function Yr(t, e) {
                  var n = Oa(t);
                  return Wo(n, or(e, 0, n.length));
                }
                function Xr(t, e, n, r) {
                  if (!$u(t)) return t;
                  for (
                    var o = -1, u = (e = gi(e, t)).length, a = u - 1, s = t;
                    null != s && ++o < u;
                ...
                function ui(t) {
                  ...
                  if (Nu(t)) return Pe(t, ui) + "";
                  if (aa(t)) return jn ? jn.call(t) : "";
                  var e = t + "";
                ...
                function si(t, e) {
                  return (
                    null == (t = Eo(t, (e = gi(e, t)))) || delete t[Uo(Yo(e))]
                  );
                }
                function ci(t, e, n, r) {
                ...
                function gi(t, e) {
                  return Nu(t) ? t : bo(t, e) ? [t] : Mo(ya(t));
                }
                var yi = Qr;
                function bi(t, e, n) {
                  var r = t.length;
                ...
                function zi(t) {
                  return function (e) {
                    return ze(Xa(qa(e).replace(Xt, "")), t, "");
                  };
                }
                function Li(t) {
                  return function () {
                ...
                function Ui(t) {
                  return $i(function (e) {
                    ...
                    for (t && e.reverse(); r--; ) {
                      ...
                      if (u && !s && "wrapper" == ro(a)) var s = new Fn([], !0);
                    }
                    for (r = s ? r : n; ++r < n; ) {
                      var c = ro((a = e[r])),
                        l = "wrapper" == c ? no(a) : i;
                ...
                function ji(t, e, n, o, u, a, s, l, f, h) {
                  var d = e & c,
                    p = 1 & e,
                    v = 2 & e,
                    g = 24 & e,
                  ...
                  return function c() {
                    ...
                    if (
                      ...
                      var S = an(_, k);
                      return Gi(t, e, ji, c.placeholder, n, _, S, l, f, h - w);
                    }
                    var E = p ? n : this,
                      A = v ? E[t] : t;
                    return (
                      ...
                      l
                        ? (_ = (function (t, e) {
                            for (
                              var n = t.length, r = yn(e.length, n), o = Ai(t);
                              r--;
                ...
                function Gi(t, e, n, r, o, u, a, c, l, f) {
                  ...
                  var d = [
                    ...
                    p = n.apply(i, d);
                  return wo(t) && xo(p, d), (p.placeholder = r), Do(p, t, e);
                }
                function Ki(t) {
                  var e = It[t];
                  return function (t, n) {
                ...
                function Zi(t, e, n, u, l, f, h, d) {
                  ...
                  return Do((b ? Hr : xo)(_, w), t, e);
                }
                function Yi(t, e, n, r) {
                  return t === i || (Ou(t, Dt[n]) && !zt.call(r, n)) ? e : t;
                }
                function Xi(t, e, n, r, o, u) {
                  return (
                    $u(t) &&
                      $u(e) &&
                      (u.set(e, t), Or(t, e, i, Xi, u), u.delete(e)),
                    t
                  );
                }
                function Hi(t) {
                ...
                function po(t) {
                  return "function" != typeof t.constructor || mo(t)
                    ? {}
                    : On(Gt(t));
                }
                function vo(t) {
                  return Nu(t) || qu(t) || !!(Zt && t && t[Zt]);
                }
                function go(t, e) {
                  var n = typeof t;
                  return (
                ...
                ((kn && fo(new kn(new ArrayBuffer(1))) != W) ||
                  (In && fo(new In()) != k) ||
                  (Sn && fo(Sn.resolve()) != E) ||
                  (En && fo(new En()) != x) ||
                  (An && fo(new An()) != D)) &&
                ...
                function qo(t, e, n) {
                  ...
                  if (!r) return -1;
                  var i = null == n ? 0 : da(n);
                  return i < 0 && (i = gn(r + i, 0)), Be(t, oo(e, 3), i);
                }
                function No(t, e, n) {
                  var r = null == t ? 0 : t.length;
                  if (!r) return -1;
                  ...
                  return (
                    n !== i &&
                      ((o = da(n)), (o = n < 0 ? gn(r + o, 0) : yn(o, r - 1))),
                    Be(t, oo(e, 3), o, !0)
                  );
                }
                function Go(t) {
                ...
                var tu = Qr(function (t) {
                    return ai(vr(t, 1, Vu, !0));
                  }),
                  eu = Qr(function (t) {
                    var e = Yo(t);
                    return Vu(e) && (e = i), ai(vr(t, 1, Vu, !0), oo(e, 2));
                  }),
                  nu = Qr(function (t) {
                    var e = Yo(t);
                    return (
                ...
                function ru(t) {
                  ...
                  return (
                    (t = Te(t, function (t) {
                      if (Vu(t)) return (e = gn(t.length, e)), !0;
                    })),
                    Qe(e, function (e) {
                      return Pe(t, Ne(e));
                    })
                ...
                var ou = Qr(function (t, e) {
                  ...
                  au = Qr(function (t) {
                    var e = Yo(t);
                    return Vu(e) && (e = i), hi(Te(t, Vu), oo(e, 2));
                  }),
                  su = Qr(function (t) {
                    var e = Yo(t);
                    return (
                      (e = "function" == typeof e ? e : i), hi(Te(t, Vu), i, e)
                    );
                  }),
                  cu = Qr(ru),
                  lu = Qr(function (t) {
                ...
                var du = $i(function (t) {
                  ...
                  pu = Ti(function (t, e, n) {
                    zt.call(t, n) ? ++t[n] : rr(t, n, 1);
                  }),
                  vu = Mi(qo),
                  gu = Mi(No);
                function yu(t, e) {
                  return (Nu(t) ? Ee : lr)(t, oo(e, 3));
                }
                function bu(t, e) {
                  return (Nu(t) ? Ae : fr)(t, oo(e, 3));
                }
                var wu = Ti(function (t, e, n) {
                    zt.call(t, n) ? t[n].push(e) : rr(t, n, [e]);
                  }),
                  _u = Qr(function (t, e, n) {
                    var i = -1,
                      o = "function" == typeof e,
                      u = Ku(t) ? r(t.length) : [];
                    return (
                ...
                function Du(t, e, n) {
                  ...
                  function w() {
                    ...
                    if (((r = arguments), (u = this), (l = t), n)) {
                      if (c === i)
                        return (function (t) {
                          return (f = t), (c = To(y, e)), h ? v(t) : s;
                        })(l);
                      if (d) return wi(c), (c = To(y, e)), v(l);
                    }
                    return c === i && (c = To(y, e)), s;
                  }
                  return (
                    (e = va(e) || 0),
                    $u(n) &&
                ...
                var Pu = Qr(function (t, e) {
                    return sr(t, 1, e);
                  }),
                  Wu = Qr(function (t, e, n) {
                ...
                function zu(t, e) {
                  ...
                  return (n.cache = new (zu.Cache || Kn)()), n;
                }
                function Lu(t) {
                  if ("function" != typeof t) throw new xt(o);
                  return function () {
                ...
                zu.Cache = Kn;
                var Mu = yi(function (t, e) {
                    var n = (e =
                      1 == e.length && Nu(e[0])
                        ? Pe(e[0], Ye(oo()))
                        : Pe(vr(e, 1), Ye(oo()))).length;
                ...
                var Cu = Ni(Sr),
                  ...
                  qu = Rr(
                    ...
                    : function (t) {
                        return (
                          ta(t) && zt.call(t, "callee") && !Vt.call(t, "callee")
                        );
                      },
                  Nu = r.isArray,
                  Gu = ye
                ...
                function ua(t) {
                  return (
                    "string" == typeof t || (!Nu(t) && ta(t) && Ir(t) == T)
                  );
                }
                function aa(t) {
                ...
                var ba = Ri(function (t, e) {
                    if (mo(e) || Ku(e)) xi(e, Da(e), t);
                    else for (var n in e) zt.call(e, n) && $n(t, n, e[n]);
                  }),
                  wa = Ri(function (t, e) {
                    xi(e, Pa(e), t);
                  }),
                  ...
                  Ia = Qr(function (t, e) {
                    ...
                    for (o && yo(e[0], e[1], o) && (r = 1); ++n < r; )
                      for (
                        var u = e[n], a = Pa(u), s = -1, c = a.length;
                        ++s < c;

                      ) {
                        var l = a[s],
                          f = t[l];
                        (f === i || (Ou(f, Dt[l]) && !zt.call(t, l))) &&
                          (t[l] = u[l]);
                      }
                    return t;
                  }),
                  Sa = Qr(function (t) {
                    return t.push(i, Xi), Ie(za, i, t);
                  });
                function Ea(t, e, n) {
                ...
                var Wa = Ri(function (t, e, n) {
                    Or(t, e, n);
                  }),
                  za = Ri(function (t, e, n, r) {
                    Or(t, e, n, r);
                  }),
                  La = $i(function (t, e) {
                    var n = {};
                ...
                function qa(t) {
                  return (t = ya(t)) && t.replace(bt, tn).replace(Ht, "");
                }
                var Na = zi(function (t, e, n) {
                    return t + (n ? "-" : "") + e.toLowerCase();
                  }),
                  Ga = zi(function (t, e, n) {
                    return t + (n ? " " : "") + e.toLowerCase();
                  }),
                  Ka = Wi("toLowerCase"),
                  Va = zi(function (t, e, n) {
                    return t + (n ? "_" : "") + e.toLowerCase();
                  }),
                  Qa = zi(function (t, e, n) {
                    return t + (n ? " " : "") + Ya(e);
                  }),
                  Za = zi(function (t, e, n) {
                ...
                function rs(t) {
                  return zr("function" == typeof t ? t : ur(t, 1));
                }
                ...
                return (
                  ...
                  (Bn.difference = Oo),
                  (Bn.differenceBy = Co),
                  (Bn.differenceWith = Fo),
                  (Bn.drop = function (t, e, n) {
                    var r = null == t ? 0 : t.length;
                    return r
                      ? ti(t, (e = n || e === i ? 1 : da(e)) < 0 ? 0 : e, r)
                      : [];
                  }),
                  ...
                  (Bn.flatMapDepth = function (t, e, n) {
                    return (n = n === i ? 1 : da(n)), vr(ku(t, e), n);
                  }),
                  (Bn.flatten = Go),
                  ...
                  (Bn.intersection = Vo),
                  (Bn.intersectionBy = Qo),
                  (Bn.intersectionWith = Zo),
                  (Bn.invert = xa),
                  (Bn.invertBy = Ta),
                  (Bn.invokeMap = _u),
                  (Bn.iteratee = rs),
                  ...
                  (Bn.pullAllWith = function (t, e, n) {
                    return t && t.length && e && e.length ? Nr(t, e, i, n) : t;
                  }),
                  (Bn.pullAt = Jo),
                  (Bn.range = hs),
                  (Bn.rangeRight = ds),
                  ...
                  (Bn.toPath = function (t) {
                    return Nu(t) ? Pe(t, Uo) : aa(t) ? [t] : Ai(Mo(ya(t)));
                  }),
                  (Bn.toPlainObject = ga),
                  ...
                  (Bn.escape = function (t) {
                    return (t = ya(t)) && Z.test(t) ? t.replace(V, en) : t;
                  }),
                  ...
                  (Bn.findKey = function (t, e) {
                    return je(t, oo(e, 3), br);
                  }),
                  (Bn.findLast = gu),
                  (Bn.findLastIndex = No),
                  (Bn.findLastKey = function (t, e) {
                    return je(t, oo(e, 3), wr);
                  }),
                  (Bn.floor = _s),
                  (Bn.forEach = yu),
                  (Bn.forEachRight = bu),
                  (Bn.forIn = function (t, e) {
                    return null == t ? t : gr(t, oo(e, 3), Pa);
                  }),
                  (Bn.forInRight = function (t, e) {
                    return null == t ? t : yr(t, oo(e, 3), Pa);
                  }),
                  ...
                  (Bn.indexOf = function (t, e, n) {
                    ...
                    if (!r) return -1;
                    var i = null == n ? 0 : da(n);
                    return i < 0 && (i = gn(r + i, 0)), Oe(t, e, i);
                  }),
                  ...
                  (Bn.isArrayBuffer = Gu),
                  (Bn.isArrayLike = Ku),
                  (Bn.isArrayLikeObject = Vu),
                  (Bn.isBoolean = function (t) {
                    return !0 === t || !1 === t || (ta(t) && Ir(t) == y);
                  }),
                  (Bn.isBuffer = Qu),
                  (Bn.isDate = Zu),
                  ...
                  (Bn.isMatch = function (t, e) {
                    return t === e || Pr(t, e, ao(e));
                  }),
                  (Bn.isMatchWith = function (t, e, n) {
                    return (
                      (n = "function" == typeof n ? n : i), Pr(t, e, ao(e), n)
                    );
                  }),
                  (Bn.isNaN = function (t) {
                    return na(t) && t != +t;
                  ...
                  (Bn.size = function (t) {
                    if (null == t) return 0;
                    if (Ku(t)) return ua(t) ? ln(t) : t.length;
                    var e = fo(t);
                    return e == k || e == x ? t.size : Lr(t).length;
                  }),
                  (Bn.snakeCase = Va),
                    ...
                    if ((a && (s += c.length - s), ia(o))) {
                      if (t.slice(s).search(o)) {
                        var l,
                          f = c;
                        for (
                          o.global || (o = Et(o.source, ya(ht.exec(o)) + "g")),
                            o.lastIndex = 0;
                          (l = o.exec(f));
                  ...
                  (Bn.unescape = function (t) {
                    return (t = ya(t)) && Q.test(t) ? t.replace(K, dn) : t;
                  }),
                  ...
                  (qn.prototype.slice = function (t, e) {
                    ...
                    return n.__filtered__ && (t > 0 || e < 0)
                      ...
                      : (t < 0 ? (n = n.takeRight(-t)) : t && (n = n.drop(t)),
                        e !== i &&
                          (n =
                            (e = da(e)) < 0 ? n.dropRight(-e) : n.take(e - t)),
                        n);
                  }),
                  ...
                  br(qn.prototype, function (t, e) {
                    ...
                    if (n) {
                      var r = n.name + "";
                      zt.call(Rn, r) || (Rn[r] = []),
                        Rn[r].push({ name: e, func: n });
                    }
                  }),
                  (Rn[ji(i, 2).name] = [{ name: "wrapper", func: i }]),
                    ...
                    return o(this, function (o) {
                      switch (o.label) {
                        case 0:
                          return (
                            this.logger.log(
                              "Requesting responsive banner for container #" + t
                            ),
                            [4, this.sdk.ensureInit(!0)]
                          );
                        case 1:
        ...
        var u = n(823),
          ...
          l = (function () {
            ...
            return (
              (t.prototype.init = function (t) {
                var e, n, r, i;
                (null === (e = null == t ? void 0 : t.fb) || void 0 === e
                  ? void 0
                  : e.interstitialId) ||
                  console.warn(
                    "InitOptions missing interstitialId, interstitial ads will not work."
                  ),
                  (null === (n = null == t ? void 0 : t.fb) || void 0 === n
                    ? void 0
                    : n.rewardedId) ||
                    console.warn(
                    ...
                    switch (i.label) {
                      ...
                      case 4:
                        return (
                          ...
                          (u = r),
                          console.error(
                            "Failed to get interstitial (midgame) ad. Code: " +
                              u.code +
                              ", message: " +
                              u.message
                          ),
                          setTimeout(function () {
                            return a.preloadInterstitialAd(t + 1);
                          }, c),
                          [2]
                        );
                      case 5:
                      ...
                      case 7:
                        return (
                          ...
                          (u = o),
                          console.error(
                            "Failed to load interstitial (midgame) ad. Code: " +
                              u.code +
                              ", message: " +
                              u.message
                          ),
                    ...
                    switch (i.label) {
                      ...
                      case 4:
                        return (
                          ...
                          (u = r),
                          console.error(
                            "Failed to get rewarded ad. Code: " +
                              u.code +
                              ", message: " +
                              u.message
                          ),
                          setTimeout(function () {
                            return a.preloadRewardedAd(t + 1);
                          }, c),
                          [2]
                        );
                      case 5:
                      ...
                      case 7:
                        return (
                          ...
                          (u = o),
                          console.error(
                            "Failed to load rewarded ad. Code: " +
                              u.code +
                              ", message: " +
                              u.message
                          ),
          ...
          s = (function () {
            ...
            return (
              ...
              (t.prototype.renderFakeAd = function (t) {
                console.log("tried to give me ad beth")
      ...
      767: function (t, e) {
        ...
        var r = "border-radius: 3px; padding: 0px 4px; color: white;",
          i = ["%cHTML5 SDK", "background-color: #6842FF; " + r],
          o = (function () {
            function t(t) {
              (this.badge = t),
                ...
                if (this.isEnabled() && this.isEnabled()) {
                  if ("none" === this.badge)
                    return console.log.apply(
                      console,
                      n(n([], i, !1), [t, e.length > 0 ? e : ""], !1)
                    );
                  var u = [];
                  switch (this.badge) {
                    case "game":
                      u = ["%cGAME", "background-color: #d48f06; " + r];
                      break;
                    case "user":
                      u = ["%cUSER", "background-color: #3498DB; " + r];
                      break;
                    case "ad":
                      u = ["%cAD", "background-color: #008A00; " + r];
                      break;
                    case "banner":
                      u = ["%cBANNER", "background-color: #00ABA9; " + r];
                  }
                  console.log(
                    i[0] + "%c " + u[0],
                    i[1],
        ...
        e.showBetaWarning = function (t) {
          n.includes(t) ||
            ...
            console.warn(
              "The " +
                t +
                " function is still in BETA, please get in touch with us if you are interested in using it."
            ),
            ["getUser", "showAuthPrompt"].includes(t) &&
              console.warn(
