!(function e(t, n, r) {
...
})(
  {
    ...
    3: [
      ...
      { "../internals/global": 54, "../internals/is-callable": 66 },
    ],
    4: [
      function (e, t, n) {
    ...
    6: [
      ...
      { "../internals/global": 54, "../internals/object-is-prototype-of": 88 },
    ],
    7: [
      function (e, t, n) {
        var r = e("../internals/global"),
      ...
      { "../internals/global": 54, "../internals/is-object": 70 },
    ],
    8: [
      function (e, t, n) {
        t.exports =
    ...
    9: [
      function (e, t, n) {
        ...
        var r,
          ...
          b = e("../internals/object-is-prototype-of"),
          ...
          L = w("toStringTag"),
          I = x("TYPED_ARRAY_TAG"),
          T = x("TYPED_ARRAY_CONSTRUCTOR"),
          U = a && !!m && "Opera" !== p(l.opera),
          M = !1,
          C = {
            Int8Array: 1,
            Uint8Array: 1,
        ...
        for (r in C) (o = (i = l[r]) && i.prototype) ? d(o, T, i) : (U = !1);
        for (r in _) (o = (i = l[r]) && i.prototype) && d(o, T, i);
        if (
          (!U || !c(R) || R === Function.prototype) &&
          ((R = function () {
            throw E("Incorrect invocation");
          }),
          U)
        )
          for (r in C) l[r] && m(l[r], R);
        if ((!U || !P || P === O) && ((P = R.prototype), U))
          for (r in C) l[r] && m(l[r].prototype, P);
        if ((U && v(A) !== P && m(A, P), s && !f(P, L)))
          for (r in ((M = !0),
          y(P, L, {
            get: function () {
      ...
      function (e, t, n) {
        ...
        var r = e("../internals/global"),
          ...
          K = function (e, t, n, r, i, o) {
            var a = d(n),
              s = R(e);
            if (a + t > s.byteLength) throw F(L);
            for (
              var l = R(s.buffer).bytes, c = a + s.byteOffset, u = r(+i), f = 0;
              f < t;
              f++
            )
              l[c + f] = u[o ? f : t - f - 1];
        ...
        if (a) {
          ...
          if (
            ...
            !u(function () {
              return new I(), new I(1.5), new I(NaN), Q && !A;
            })
          )
            Q && A && l(I, "name", O);
          else {
            (T = function (e) {
              return f(this, U), new I(d(e));
            }).prototype = U;
          ...
          (U = (T = function (e) {
            f(this, U);
            var t = d(e);
            P(this, { bytes: q(B(t), 0), byteLength: t }),
              o || (this.byteLength = t);
          }).prototype),
            (C = (M = function (e, t, n) {
              f(this, C), f(e, U);
              ...
              P(this, { buffer: e, byteLength: n, byteOffset: i }),
                o ||
                  ((this.buffer = e),
                  (this.byteLength = n),
                  (this.byteOffset = i));
            ...
            c(C, {
              ...
              getInt32: function (e) {
                return G(
                  X(this, 4, e, arguments.length > 1 ? arguments[1] : void 0)
                );
              },
              ...
              getFloat64: function (e) {
                return H(
                  X(this, 8, e, arguments.length > 1 ? arguments[1] : void 0),
                  52
                );
              },
              setInt8: function (e, t) {
        ...
        j(T, O), j(M, E), (t.exports = { ArrayBuffer: T, DataView: M });
      },
      {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e) {
          ...
          var b,
            ...
            S = 0;
          if (!k || (this == d && l(k)))
            for (b = u(t), v = n ? new this(b) : d(b); b > S; S++)
              (j = y ? g(t[S], S) : t[S]), f(v, S, j);
          else
            for (
              x = (w = p(t, k)).next, v = n ? new this() : [];
              !(m = o(x, w)).done;
              S++
            )
              (j = y ? s(w, g, [m.value, S], !0) : m.value), f(v, S, j);
          return (v.length = S), v;
        };
      },
      {
            ...
            return function (d, g, y, b) {
              for (
                var v,
                  ...
                  S = 0,
                  A = b || l,
                  R = t ? A(d, k) : n || p ? A(d, 0) : void 0;
                k > S;
                S++
              )
                if ((h || S in x) && ((m = j((v = x[S]), S, w)), e))
                  if (t) R[S] = m;
                  else if (m)
                    switch (e) {
                      case 3:
    ...
    19: [
      ...
      { "../internals/an-object": 7, "../internals/iterator-close": 73 },
    ],
    20: [
      function (e, t, n) {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n, a, d, y, R) {
          ...
          var P,
            ...
            T = !1,
            U = e.prototype,
            M = U[x] || U["@@iterator"] || (d && U[d]),
            C = (!w && M) || L(d),
            _ = ("Array" == t && U.entries) || M;
          if (
            (_ &&
              (P = c(_.call(new e()))) !== Object.prototype &&
              P.next &&
              (o || c(P) === m || (u ? u(P, m) : s(P[x]) || h(P, x, A)),
              f(P, I, !0, !0),
              o && (g[I] = A)),
            b &&
              d == k &&
            ...
            if (((O = { values: L(k), keys: y ? C : L(j), entries: L(S) }), R))
              for (E in O) (w || T || !(E in U)) && h(U, E, O[E]);
            else r({ target: t, proto: !0, forced: w || T }, O);
          return (
            (o && !R) || U[x] === C || h(U, x, C, { name: d }), (g[t] = C), O
          );
        };
      },
      {
    ...
    37: [
      ...
      { "../internals/engine-user-agent": 36, "../internals/global": 54 },
    ],
    38: [
      function (e, t, n) {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n, f) {
          ...
          if (!h || !d || n) {
            ...
            i(String.prototype, e, y[0]), i(u, p, y[1]);
          }
          f && l(u[p], "sham", !0);
        };
      },
    ...
    47: [
      ...
      { "../internals/descriptors": 30, "../internals/has-own-property": 55 },
    ],
    48: [
      function (e, t, n) {
        var r = e("../internals/function-bind-native"),
        ...
        t.exports = {
          ...
          unpack: function (e, t) {
            var n,
              ...
              u = e[c--],
              f = 127 & u;
            for (u >>= 7; l > 0; ) (f = 256 * f + e[c--]), (l -= 8);
            for (n = f & ((1 << -l) - 1), f >>= -l, l += t; l > 0; )
              (n = 256 * n + e[c--]), (l -= 8);
            if (0 === f) f = 1 - s;
            else {
      ...
      function (e, t, n) {
        ...
        if (a || p.state) {
          var v = p.state || (p.state = new b()),
            ...
            x = l(v.set);
          (r = function (e, t) {
            if (w(v, e)) throw new y(g);
            return (t.facade = e), x(v, e, t), t;
          }),
            (i = function (e) {
              return m(v, e) || {};
            }),
    ...
    64: [
      ...
      { "../internals/iterators": 75, "../internals/well-known-symbol": 132 },
    ],
    65: [
      function (e, t, n) {
    ...
    68: [
      ...
      { "../internals/fails": 41, "../internals/is-callable": 66 },
    ],
    69: [
      function (e, t, n) {
    ...
    77: [
      ...
      { "../internals/engine-v8-version": 37, "../internals/fails": 41 },
    ],
    78: [
      function (e, t, n) {
        var r = e("../internals/fails"),
      ...
      function (e, t, n) {
        ...
        t.exports =
          ...
          a(function () {
            ...
            ? function (e, t) {
                for (
                  var n = u(e), i = arguments.length, a = 1, p = l.f, h = c.f;
                  i > a;
    ...
    98: [
      function (e, t, n) {
        ...
        var r,
          ...
          p = e("../internals/internal-state").get,
          h = e("../internals/regexp-unsupported-dot-all"),
          d = e("../internals/regexp-unsupported-ncg"),
        ...
        (j || S || k || h || d) &&
          (b = function (e) {
            ...
            if (
              ...
              for (i.groups = c = f(null), a = 0; a < P.length; a++)
                c[(u = P[a])[0]] = i[u[1]];
            return i;
          }),
          (t.exports = b);
    ...
    100: [
      ...
      { "../internals/fails": 41, "../internals/global": 54 },
    ],
    101: [
      function (e, t, n) {
        var r = e("../internals/fails"),
    ...
    107: [
      ...
      { "../internals/shared": 109, "../internals/uid": 128 },
    ],
    108: [
      function (e, t, n) {
        var r = e("../internals/global"),
      ...
      { "../internals/global": 54, "../internals/set-global": 104 },
    ],
    109: [
      function (e, t, n) {
      ...
      { "../internals/is-pure": 71, "../internals/shared-store": 108 },
    ],
    110: [
      function (e, t, n) {
        var r = e("../internals/function-uncurry-this"),
      ...
      function (e, t, n) {
        ...
        var r = e("../internals/global"),
          ...
          x = function (e) {
            ...
            var n,
              ...
              s = 0,
              u = 72;
            for (n = 0; n < e.length; n++) (r = e[n]) < 128 && g(t, p(r));
            var y = t.length,
              b = y;
            for (y && g(t, "-"); b < i; ) {
              var v = o;
              for (n = 0; n < e.length; n++)
                (r = e[n]) >= a && r < v && (v = r);
              var x = b + 1;
              if (v - a > f((o - s) / x)) throw c(l);
              for (s += (v - a) * x, a = v, n = 0; n < e.length; n++) {
                if ((r = e[n]) < a && ++s > o) throw c(l);
                if (r == a) {
                  for (var j = s, k = 36; ; ) {
                    ...
                    var A = j - S,
                      R = 36 - S;
                    g(t, p(m(S + (A % R)))), (j = f(A / R)), (k += 36);
                  }
                  g(t, p(m(j))), (u = w(s, x, b == y)), (s = 0), b++;
                }
              }
              s++, a++;
            }
        ...
        t.exports = function (e) {
          ...
          for (t = 0; t < i.length; t++)
            (n = i[t]), g(r, u(a, n) ? "xn--" + x(n) : n);
          return d(r, ".");
        };
      },
      { "../internals/function-uncurry-this": 48, "../internals/global": 54 },
    ],
    112: [
      function (e, t, n) {
    ...
    118: [
      ...
      { "../internals/global": 54, "../internals/to-positive-integer": 119 },
    ],
    119: [
      function (e, t, n) {
        var r = e("../internals/global"),
      ...
      { "../internals/global": 54, "../internals/to-integer-or-infinity": 115 },
    ],
    120: [
      function (e, t, n) {
        var r = e("../internals/global"),
        ...
        t.exports = function (e, t) {
          ...
          if (r) {
            if (
              (void 0 === t && (t = "default"), (n = i(r, e, t)), !o(n) || a(n))
            )
              return n;
    ...
    121: [
      ...
      { "../internals/is-symbol": 72, "../internals/to-primitive": 120 },
    ],
    122: [
      function (e, t, n) {
        var r = {};
    ...
    123: [
      ...
      { "../internals/classof": 22, "../internals/global": 54 },
    ],
    124: [
      function (e, t, n) {
      ...
      function (e, t, n) {
        ...
        var r = e("../internals/export"),
          ...
          Z = function (e) {
            var t;
            return (
              k(N, e) || "ArrayBuffer" == (t = m(e)) || "SharedArrayBuffer" == t
            );
          },
          ee = function (e, t) {
          ...
          te = function (e, t) {
            return (t = b(t)), ee(e, t) ? f(2, e[t]) : _(e, t);
          },
          ne = function (e, t, n) {
            return (
              (t = b(t)),
              !(ee(e, t) && w(n) && v(n, "value")) ||
              v(n, "get") ||
              v(n, "set") ||
              n.configurable ||
              ...
              H
                ...
                : ((b = t(function (e, t, n, r) {
                    ...
                    var i,
                      ...
                      f = 0;
                    if (w(t)) {
                      if (!Z(t)) return $(t) ? K(b, t) : o(R, b, t);
                      (i = t), (f = y(n, a));
                      var p = t.byteLength;
                      if (void 0 === r) {
                        if (p % a) throw F(X);
                        if ((s = p - f) < 0) throw F(X);
                      } else if ((s = d(r) * a) + f > p) throw F(X);
                      l = s / a;
                    } else (l = g(t)), (i = new q((s = l * a)));
                    for (
                      M(e, {
                        buffer: i,
                        byteOffset: f,
                ...
                z && p(v, z, l),
                (m[l] = b),
                r({ global: !0, forced: b != h, sham: !H }, m),
                J in b || p(b, J, a),
                J in v || p(v, J, a),
                O(l);
            }))
      ...
      function (e, t, n) {
        ...
        t.exports = function (e) {
          var t,
            ...
            x = c(b);
          if (x && !u(x))
            for (g = (d = l(b, x)).next, b = []; !(h = i(g, d)).done; )
              b.push(h.value);
          for (
            w && v > 2 && (m = r(m, arguments[2])),
              n = s(b),
              p = new (f(y))(n),
              t = 0;
            n > t;
    ...
    130: [
      ...
      { "../internals/descriptors": 30, "../internals/fails": 41 },
    ],
    131: [
      function (e, t, n) {
        var r = e("../internals/global").TypeError;
    ...
    133: [
      function (e, t, n) {
        ...
        if (
          (i("keys"), i("values"), i("entries"), !c && u && "values" !== d.name)
        )
          try {
    ...
    134: [
      ...
      { "../internals/export": 40, "../internals/regexp-exec": 98 },
    ],
    135: [
      function (e, t, n) {
        "use strict";
            ...
            return [
              ...
              function (e, i) {
                ...
                for (var O, E = "", L = 0, I = 0; I < R.length; I++) {
                  for (
                    var T = p((P = R[I])[0]),
                      U = m(w(u(P.index), s.length), 0),
                      M = [],
                      C = 1;
                    C < P.length;
                    C++
                  )
                    j(M, void 0 === (O = P[C]) ? O : String(O));
                  var _ = P.groups;
                  if (g) {
                    var B = x([T], M, U, s);
                    void 0 !== _ && j(B, _);
                    var F = p(r(i, void 0, B));
                  } else F = y(T, s, U, M, _, i);
                  U >= L && ((E += S(s, L, U) + F), (L = U + T.length));
                }
                return E + S(s, L);
              },
            ];
    ...
    137: [
      function (e, t, n) {
        ...
        (0,
        e("../internals/array-buffer-view-core").exportTypedArrayStaticMethod)(
          "from",
          e("../internals/typed-array-from"),
          r
        );
      },
      {
    ...
    143: [
      function (e, t, n) {
        ...
        for (var h in i) p(r[h] && r[h].prototype, h);
        p(o, "DOMTokenList");
      },
      {
        "../internals/create-non-enumerable-property": 26,
    ...
    144: [
      function (e, t, n) {
        ...
        var r = e("../internals/export"),
          ...
          se = p(
            function (e, t) {
              T(this, { type: I, iterator: S(U(e).entries), kind: t });
            },
            "Iterator",
            function () {
              var e = M(this),
          ...
          parseQuery: function (e) {
            if (e)
              for (var t, n, r = X(e, "&"), i = 0; i < r.length; )
                (t = r[i++]).length &&
                  ((n = X(t, "=")),
                  G(this.entries, { key: ne($(n)), value: ne(V(n, "=")) }));
          },
          serialize: function () {
        ...
        if (
          (u(
            ue,
            {
              append: function (e, t) {
                ...
                var n = U(this);
                G(n.entries, { key: x(e), value: x(t) }), n.updateURL();
              },
              delete: function (e) {
                R(arguments.length, 1);
                for (
                  var t = U(this), n = t.entries, r = x(e), i = 0;
                  i < n.length;
              ...
              get: function (e) {
                R(arguments.length, 1);
                for (
                  var t = U(this).entries, n = x(e), r = 0;
                  r < t.length;
                  r++
                )
              ...
              getAll: function (e) {
                R(arguments.length, 1);
                for (
                  var t = U(this).entries, n = x(e), r = [], i = 0;
                  i < t.length;
                  i++
                )
              ...
              has: function (e) {
                R(arguments.length, 1);
                for (var t = U(this).entries, n = x(e), r = 0; r < t.length; )
              ...
              set: function (e, t) {
                ...
                for (
                  ...
                  (n = i[l]).key === a &&
                    (o ? J(i, l--, 1) : ((o = !0), (n.value = s)));
                o || G(i, { key: a, value: s }), r.updateURL();
              },
              sort: function () {
                var e = U(this);
          ...
          c(ue, E, ue.entries, { name: "entries" }),
          c(
            ue,
            "toString",
            function () {
          ...
          f(ce, L),
          r({ global: !0, forced: !l }, { URLSearchParams: ce }),
          !l && g(B))
        ) {
          var fe = s(q.has),
            pe = s(q.set),
              ...
              if (w(e)) {
                ...
                if (v(n) === L)
                  return (
                    ...
                    j(e, { body: k(0, x(n)), headers: k(0, t) })
                  );
              }
              return e;
            };
          if (
            ...
            (F.constructor = de),
              (de.prototype = F),
              r({ global: !0, forced: !0 }, { Request: de });
          }
        }
        t.exports = { URLSearchParams: ce, getState: U };
      },
      {
        "../internals/an-instance": 6,
        "../internals/an-object": 7,
    ...
    146: [
      function (e, t, n) {
        ...
        var r,
          ...
          u = e("../internals/object-define-properties").f,
          f = e("../internals/redefine"),
          p = e("../internals/an-instance"),
          h = e("../internals/has-own-property"),
          d = e("../internals/object-assign"),
          g = e("../internals/array-from"),
          y = e("../internals/array-slice-simple"),
          b = e("../internals/string-multibyte").codeAt,
          v = e("../internals/string-punycode-to-ascii"),
          m = e("../internals/to-string"),
          w = e("../internals/set-to-string-tag"),
          x = e("../internals/validate-arguments-length"),
          j = e("../modules/web.url-search-params.constructor"),
          k = e("../internals/internal-state"),
          S = k.set,
          A = k.getterFor("URL"),
          R = j.URLSearchParams,
          ...
          oe = function (e) {
            var t, n, r, i;
            if ("number" == typeof e) {
              for (t = [], n = 0; n < 4; n++) z(t, e % 256), (e = I(e / 256));
              return C(t, ".");
            }
            if ("object" == typeof e) {
              for (
          ...
          _e = function (e, t, n) {
            ...
            if (t) {
              ...
              if (
                ...
                throw E(i);
              (o = P(new R())).bindURL(this), (this.searchParams = o);
            }
          };
        _e.prototype = {
          type: "URL",
          parse: function (e, t, n) {
            ...
            for (
              ...
              switch (((o = i[f]), u)) {
                  ...
                  if (o && (M(J, o) || "+" == o || "-" == o || "." == o))
                    ...
                    (p = ""),
                      "file" == c.scheme
                        ...
                        : "/" == i[f + 1]
                        ? ((u = me), f++)
                        : ((c.cannotBeABaseURL = !0), F(c.path, ""), (u = Ue));
                  }
                  break;
                case be:
                  ...
                  if (!M(X, o)) {
                    if (
                      ...
                      if ("" != p) {
                        ...
                        if (k > 65535) return Y;
                        (c.port =
                          c.isSpecial() && k === fe[c.scheme] ? null : k),
                          (p = "");
                      }
                      if (t) return;
                      u = Ie;
                ...
                case Ie:
                  if (c.isSpecial()) {
                    if (((u = Te), "/" != o && "\\" != o)) continue;
                  } else if (t || "?" != o)
                    if (t || "#" != o) {
                      if (o != r && ((u = Te), "/" != o)) continue;
                    } else (c.fragment = ""), (u = Ce);
                  else (c.query = ""), (u = Me);
                  break;
                case Te:
                  if (
          ...
          setPort: function (e) {
            this.cannotHaveUsernamePasswordPort() ||
              ("" == (e = m(e)) ? (this.port = null) : this.parse(e, Pe));
          },
        ...
        w(Be, "URL"), i({ global: !0, forced: !a, sham: !o }, { URL: Be });
      },
      {
        "../internals/an-instance": 6,
        ...
        n.HostInfo = class {
            ...
            (n.onload = () => {
              ...
              (this.systemInfo = (function () {
                ...
                const r = (function () {
                  ...
                  a = /Mobile|mini|Fennec|Android|iP(ad|od|hone)/.test(
          ...
          wasmSupportLevel() {
            ...
            return Number.parseInt(
              this.systemInfo.browserVersion.split(".")[0],
              10
            ) < 14
              ? "partial"
              : "supported";
          ...
          caniuseTool(e, t, n) {
            return new Promise((r) => {
              const o = e.substr(0, e.lastIndexOf("/") + 1),
                a = o + n + "/caniuse." + n;
              void 0 === this.caniuse[a] &&
                (this.caniuse[a] = (0, i.loadResource)(
                  a + "?time=" + Date.now(),
                  "text"
                )
                  .then(
          ...
          getDeviceModel(e, t, n, r) {
            ...
            return t.match(/^apple+[a-zA-Z0-9_\s]+gpu$/i)
              ? this.getAppleDeviceModel(r)
              : this.getAndroidDeviceModel(n);
          }
        ...
        n.mountJs = async function (e) {
          const t = async function (e) {
            ...
            const o =
                null !==
                  (t =
                    null === (n = r.testkit) || void 0 === n
                      ? void 0
                      : n.overrideFileUrl(e)) && void 0 !== t
                  ? t
                  : e,
      ...
      function (e, t, n) {
        ...
        e("core-js/modules/web.dom-collections.iterator.js"),
          ...
          (n.loadResource = async function (e, t) {
            ...
            const a =
                i || parseInt(o.headers.get("Content-Length") || "0", 10) || 0,
              s = r(o, a, n);
            switch (t) {
              case "text":
                return s.text();
      ...
      function (e, t, n) {
        ...
        class h {
          ...
          log() {
            ...
            (0, u.log)(
              this.startedAt,
              this.host.systemInfo.devHost || this.verbose,
              ...t
            );
          }
          loadResource(e, t, n) {
            return "response" === t
              ? (0, a.loadResource)(e, t, n, this.resourceSize(e))
              : (0, s.loadResource)(e, t, n, this.resourceSize(e));
          }
          resourceSize(e) {
          ...
          async createImageLoader(e, t, n) {
            ...
            const d =
                null !==
                  (i =
                    null === (o = f.testkit) || void 0 === o
                      ? void 0
                      : o.overrideFileUrl(e)) && void 0 !== i
                  ? i
                  : e,
              g =
                "js" ===
                (null === (a = f.testkit) || void 0 === a
                  ? void 0
                  : a.imageLoaderType),
              y =
                "wasm" ===
                (null === (s = f.testkit) || void 0 === s
                  ? void 0
                  : s.imageLoaderType),
              b =
                "undefined" != typeof createImageBitmap &&
                "undefined" != typeof OffscreenCanvas &&
                this.host.webpSupported;
            if (g || (!y && b))
              try {
                return (
                  (this.imageLoader = await (0, p.createBrowserImageLoader)(d)),
            ...
            (this.imageLoader = await (0, p.createWasmImageLoader)(
              null !==
                (l =
                  null === (c = f.testkit) || void 0 === c
                    ? void 0
                    : c.overrideFileUrl(t)) && void 0 !== l
                ? l
                : t,
              null !==
                (u =
                  null === (h = f.testkit) || void 0 === h
                    ? void 0
                    : h.overrideFileUrl(n)) && void 0 !== u
                ? u
                : n
            )),
          ...
          async load() {
            ...
            try {
              ...
              return (
                alert("Can't start gpx.json not found"),
            ...
            this.verbose =
              null !== (e = this.config.verbose) && void 0 !== e && e;
            const i = [
              ...(null !== (t = this.config.sdkScripts) && void 0 !== t
                ? t
                : []),
              ...(null !== (n = this.config.runtime.initialScripts) &&
              void 0 !== n
                ? n
                : []),
            ];
            try {
              ...
              return (
                alert("Unable to mount init scripts"),
                void this.log("ERR! Unable to mount init scripts", e)
              );
            }
            if (
              void 0 !== this.config.workerScripts &&
              void 0 !== this.config.workerScripts.browserImageLoader &&
              void 0 !== this.config.workerScripts.wasmImageLoader
            )
              try {
                await this.createImageLoader(
                  this.config.workerScripts.browserImageLoader,
                  this.config.workerScripts.wasmImageLoader.wasm,
                  this.config.workerScripts.wasmImageLoader.wasmJs
                );
              } catch (e) {
                this.log(
                  "ERR! Unable to create worker for image loading: " + e
                ),
                  this.errors.push({
                    name: e.name,
                    message: e.message,
              ...
              this.log(
                "ERR! Unable to find worker image loader scripts. Direct image loader will be used"
              );
            ...
            return new Promise(async (n, r) => {
              ...
              try {
                ...
                const t =
                    null !==
                      (a =
                        null === (l = f.testkit) || void 0 === l
                          ? void 0
                          : l.overrideFileUrl(i.getConfigEndpoint)) &&
                    void 0 !== a
                      ? a
                      : i.getConfigEndpoint,
                  n = { "Content-type": "application/json" },
                  r = JSON.stringify({ config: e, host: this.host }),
                  o = await (0, s.loadResource)(
                    t,
                    "text",
                    () => {},
                    void 0,
                ...
                this.log(
                  "ERR! Unable to get config from server, using original one",
                  e
                ),
                  this.errors.push({
                    name: e.name,
        ...
        (n.TinyLoader = h), (window.tinyLoader = new h());
      },
      {
        "../config": 148,
        "../testkit/testkit": 149,
      ...
      function (e, t, n) {
        ...
        function i(e) {
          return new Promise((t, n) => {
            const r = (i) => {
              void 0 === i.data.error
                ? "ready" === i.data.command &&
                  (e.removeEventListener("message", r), t())
                : n(i.data.error);
            };
        ...
        (n.createBrowserImageLoader = async function (e) {
          ...
          const t = await (0, r.loadResource)(e, "response"),
            n = await t.blob(),
            o = URL.createObjectURL(n),
            a = new Worker(o),
            s = new OffscreenCanvas(2048, 2048);
          a.postMessage({ command: "init", canvas: s }, [s]);
          try {
            await i(a);
          } catch (e) {
            throw new Error(e);
