function createUnityInstance(e, t, n) {
  ...
  function i(e, t, n) {
    if (e.indexOf("fullscreen error") == -1) {
      if (l.startupErrorHandler) return void l.startupErrorHandler(e, t, n);
      if (
        !(
  ...
  function s(e, t) {
    if ("symbolsUrl" != e) {
      var r = l.downloadProgress[e];
      r ||
        (r = l.downloadProgress[e] =
          {
            started: !1,
            finished: !1,
            lengthComputable: !1,
      ...
      for (var e in l.downloadProgress) {
        ...
        i++,
          r.lengthComputable
            ? ((o += r.loaded), (a += r.total), s++)
            : r.finished || u++;
      }
      var c = i ? (i - u - (a ? (s * (a - o)) / a : 0)) / i : 0;
      n(0.9 * c);
    }
  }
  function u(e) {
    s(e);
    var t = l.cacheControl(l[e]),
      n = l.companyName && l.productName ? l.cachedFetch : l.fetchWithProgress,
      o = l[e],
    ...
    return i
      ...
      .catch(function (t) {
        var n = "Failed to download file " + l[e];
      ...
      (n.src = l.frameworkUrl),
        (n.onload = function () {
          if ("undefined" == typeof unityFramework || !unityFramework) {
            ...
            for (var o in t) {
              var a = t[o];
              if (l.frameworkUrl.endsWith("." + a[0])) {
                var i = "Unable to parse " + l.frameworkUrl + "!";
          ...
          (unityFramework = null), (n.onload = null), e(u);
        }),
      ...
      l.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (n += 4; n < o; ) {
            ...
            n += 4;
            var u = String.fromCharCode.apply(null, e.subarray(n, n + s));
            n += s;
            for (
              var c = 0, d = u.indexOf("/", c) + 1;
              d > 0;
              c = d, d = u.indexOf("/", c) + 1
            )
              l.FS_createPath(u.substring(0, c), u.substring(c, d - 1), !0, !0);
            l.FS_createDataFile(u, null, e.subarray(a, a + i), !0, !0, !0);
          }
  ...
  return (
    ...
    (l.readBodyWithProgress = (function () {
      function e(e, t) {
        if (!t) return 0;
      ...
      function t(t, n) {
        function r() {
          return "undefined" == typeof a
            ...
            : a.read().then(function (e) {
                return e.done
                  ? o()
                  : (d + e.value.length <= u.length
                      ? (u.set(e.value, d), (l = d + e.value.length))
                      : c.push(e.value),
                    (d += e.value.length),
                    n({
                      type: "progress",
        ...
        function o() {
          if (d === s) return u;
          if (d < s) return u.slice(0, d);
          var e = new Uint8Array(d);
          e.set(u, 0);
          for (var t = l, n = 0; n < c.length; ++n)
            e.set(c[n], t), (t += c[n].length);
          return e;
        }
    ...
    (l.fetchWithProgress = (function () {
      function e(e, t) {
        var n = function () {};
        return (
          t && t.onProgress && (n = t.onProgress),
          fetch(e, t).then(function (e) {
            return l.readBodyWithProgress(e, n);
          })
        );
      }
      return e;
    })()),
    (l.UnityCache = (function () {
      function e(e) {
      ...
      return (
        ...
        (t.prototype.connect = function () {
          ...
          var t = new Promise(function (t, r) {
            ...
            .then(function () {
              var e = n.name + "_" + l.companyName + "_" + l.productName;
        ...
        (t.prototype.cleanUpCache = function () {
          ...
          return this.getMetaDataEntries().then(function (n) {
            ...
            function a() {
              if (0 === u.length) return Promise.resolve();
              var t = u.pop();
              return e.cache
                .delete(t.url)
                .then(function (e) {
            ...
            for (
              var i = n.metaDataEntries, s = n.cacheSize, u = [], c = [], d = 0;
              d < i.length;
              ++d
            )
              i[d].version != l.productVersion
                ? (u.push(i[d]), (s -= i[d].size))
                : c.push(i[d]);
            c.sort(function (e, t) {
              return e.accessedAt - t.accessedAt;
            });
            for (var d = 0; d < c.length && !(s < t.MaximumCacheSize); ++d)
              u.push(c[d]), (s -= c[d].size);
            return a();
          });
        }),
        t
      ...
      function o(o, u) {
        function c(t, n) {
          return fetch(t, n).then(function (r) {
            if (!h.enabled || h.revalidated) return r;
            if (304 === r.status)
              return (
                (h.revalidated = !0),
                d
                  .updateRequestMetaData(h.metaData)
                  .then(function () {
                    e(
                      "'" +
                        h.metaData.url +
                ...
                s(h.response, n.onProgress)
              );
            if (200 == r.status) {
              (h.response = r),
                (h.metaData.updatedAt = h.metaData.accessedAt),
                (h.revalidated = !0);
              var o = r.clone();
              return s(r, n.onProgress).then(function (n) {
                return (
                  (h.metaData.size = n.parsedBody.length),
                  Promise.all([
                    d.storeRequest(t, o),
                    d.updateRequestMetaData(h.metaData),
                  ])
                    .then(function () {
                      e(
                        "'" +
        ...
        var d = a.getInstance(),
          l = t("string" == typeof o ? o : o.url),
          h = { enabled: r(l, u) };
        return (
          u &&
            ((h.control = u.control),
            (h.companyName = u.companyName),
            (h.productName = u.productName),
            (h.productVersion = u.productVersion)),
          (h.revalidated = !1),
          (h.metaData = {
            url: l,
            accessedAt: Date.now(),
          ...
          h.enabled
            ? d
                ...
                .then(function (t) {
                  ...
                  if (
                    ((h.response = r),
                    (h.metaData.size = a.size),
                    (h.metaData.updatedAt = a.updatedAt),
                    "immutable" == h.control)
                  )
                    return (
                      (h.revalidated = !0),
                  ...
                  if (
                    ...
                    return fetch(l, { method: "HEAD" }).then(function (t) {
                      return (
                        (h.revalidated = ["Last-Modified", "ETag"].every(
                          function (e) {
                            return (
                              !r.headers.get(e) ||
      ...
      if (l.SystemInfo.hasWebGL)
        if (1 == l.SystemInfo.hasWebGL) {
          ...
          "Safari" == l.SystemInfo.browser &&
            ...
            (r +=
              l.SystemInfo.mobile || navigator.maxTouchPoints > 1
          ...
          l.SystemInfo.hasWasm
            ? ((l.startupErrorHandler = t),
              ...
              l.postRun.push(function () {
                n(1), delete l.startupErrorHandler, e(g);
              }),
              d())
