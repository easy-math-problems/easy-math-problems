		...
		var backupApps = [
			{
				...
				name: "Fruita Crush",
				thumb:"images/tmp/180/FruitaCrushTeaser.jpg"
			},
			{
				id: "famobi/solitaire-classic",
				name: "Solitaire Classic",
				thumb:"images/tmp/180/SolitaireClassicTeaser.jpg"
			},
			{
				id: "famobi/smarty-bubbles-xmas",
				name: "Smarty Bubbles X-MAS EDITION",
				thumb:"images/tmp/180/SmartyBubblesXmasTeaser.jpg"
			},
			{
				id: "famobi/jewelish",
				name: "Jewelish",
				thumb:"images/tmp/180/Jewelish_Teaser.jpg"
			},
			{
				id: "famobi/archery-world-tour",
				name: "Archery World Tour",
				thumb:"images/tmp/180/ArcheryWorldTourTeaser.jpg"
			},
			{
				id: "famobi/penalty-shooters-2",
				name: "Penalty Shooters 2",
				thumb:"images/tmp/180/PenaltyShooters2Teaser.jpg"
			},
			{
				id: "famobi/wedding-lily",
				name: "Wedding Lily",
				thumb:"images/tmp/180/WeddingLilyTeaser.jpg"
			}
		];
        ...
        function () {
            ...
            const BRIDGE = {
                ...
                famobi: {
                    ...
                    gameOver() {
                        this.result = "fail";
                        return window.famobi_analytics.trackEvent("EVENT_CUSTOM", {eventName: "LEVELEND", score: this.score || 0, result: this.result});
                    },
                    ...
                    hasCooledDown() {
                        if(window.famobi_gameID === "train-miner") {
...
fg_api.prototype.trackingModule = function() {
	...
	module.prototype.initializeGoogleTracking = function() {
		if (!self.hasFeature("tracking") || self.hasFeature("standalone")) {
...
fg_api.prototype.init = function () {
	...
	self.config.blurred_thumb =
		self.config.blurred_thumb ||
		"images/tmp/blurred/RacingMonsterTrucksTeaser.jpg";
