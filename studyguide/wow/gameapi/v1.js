(function(d, params, env, apiHost, hosts) {
	...
	if (params.fg_domain && params.fg_uid && params.fg_pid) {
		...
		})(d, "script/909e737d-670d-4a40-be08-73165d13351d4638e320-4444-4514-81c4-d80a8c662371");//d.location.protocol + '//' + apiHost + '.famobi.com/gameapi/script/' + params.fg_uid + '/' + params.fg_pid);
	}
})(document, {}, '', '', {
	'dev': 'api.dev', 
